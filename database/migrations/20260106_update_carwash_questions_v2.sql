...
-- VERSION 2: Removed conditional_field columns (not in schema)
-- =============================================================================
...
SELECT id, 
  ...
  200,
  false,
  'Express tunnels typically 80-180 feet. Mini-tunnels under 60 feet. Only applies to tunnel types.',
  3,
  'Facility Basics'
FROM use_cases WHERE slug = 'car-wash';
