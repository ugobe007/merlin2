...
export const SITE_COPY_DEFAULTS: Record<string, string> = {
  ...
  modal_headline: "Get Your Free Energy Report",
  modal_subtext: "See exactly how much you could save — takes 30 seconds.",
  modal_cta_text: "Get My Free Report",
  modal_social_proof: "Free forever · No credit card · No spam",
