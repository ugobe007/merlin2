...
export function formatLargeFinancialValue(
  value: number,
  context: "project" | "annual" | "general" = "general"
): {
  formatted: string;
  units: "K" | "M" | "B";
  rawValue: number;
...
export function formatSolarSavings(
  solarMW: number,
  electricityRate: number,
  context: "display" | "calculation" = "display"
): {
...
export function formatTotalProjectSavings(
...
export function formatCurrencyConsistent(
  value: number,
  projectScale: "micro" | "small" | "medium" | "large" | "utility" = "medium"
): string {
