...
export const generateCalculationBreakdown = (
  ...
  calculations.push({
    ...
    resultUnit: "MWh",
    explanation:
      "Total energy storage capacity using NREL ATB 2024 methodology. Determines system ability to store and deliver energy.",
    assumptions: [
  ...
  calculations.push({
    ...
    resultUnit: "$/kW",
    explanation:
      "NREL ATB 2024 official formula for utility-scale battery storage costs. Separates energy and power-related costs.",
    assumptions: [
  ...
  calculations.push({
    ...
    resultUnit: "$",
    explanation:
      "Lithium-ion battery pack including cells, BMS (Battery Management System), thermal management, and enclosures.",
    assumptions: [
  ...
  if (solarMW > 0) {
    ...
    calculations.push({
      ...
      assumptions: [
        ...
        solarMW >= 5
          ? "Utility-scale: Fixed-tilt or tracking"
          : "Commercial: Rooftop or ground-mount",
      ],
    });
  }
  ...
  if (windMW > 0) {
    ...
    calculations.push({
      ...
      resultUnit: "$",
      explanation:
        "Wind turbine generators with foundations, electrical infrastructure, and grid connection.",
      assumptions: [
  ...
  calculations.push({
    ...
    resultUnit: "$",
    explanation:
      "Engineering, Procurement, and Construction (EPC) covers design, installation, and commissioning.",
    assumptions: [
  ...
  calculations.push({
    ...
    resultUnit: "$",
    explanation:
      "Total Battery Energy Storage System capital expenditure (turnkey installed cost).",
  });
    ...
    selectedApplications.forEach((app) => {
      ...
      if (app === "EV Charging Stations" && config) {
        ...
        const transformerCost =
          config.voltage === "600V" ? 45000 : config.voltage === "480V" ? 30000 : 15000;
      ...
      if (app === "Data Centers" && config) {
        ...
        const redundancyCost =
          config.redundancyLevel === "2N" ? 250000 : config.redundancyLevel === "N+1" ? 100000 : 0;
        ...
        calculations.push({
          ...
          resultUnit: "$",
          explanation:
            "UPS systems and redundancy infrastructure for continuous data center operation.",
          assumptions: [
      ...
      if (app === "Manufacturing" && config) {
        ...
        const shiftCost =
          config.loadProfile === "3-shift" ? 80000 : config.loadProfile === "2-shift" ? 50000 : 0;
        ...
        calculations.push({
          ...
          resultUnit: "$",
          explanation:
            "Specialized equipment to protect critical manufacturing processes and support multi-shift operations.",
        });
      }
    });
  }
