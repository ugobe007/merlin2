...
import { Settings, Database, Download, Upload, RotateCcw, Save, AlertTriangle, CheckCircle, RefreshCw, Bell, Cloud, CloudOff } from "lucide-react";
...
export const PricingAdminDashboard: React.FC<PricingAdminProps> = ({ isOpen, onClose }) => {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-200 rounded-lg p-4 shadow-sm">
          ...
          <p className="text-sm text-purple-700">
            Pricing is automatically validated daily at 6 AM against NREL ATB 2024, BloombergNEF,
            Wood Mackenzie, and other market intelligence sources. Deviations &gt;10% trigger
            alerts.
          </p>
        </div>
      ...
      <div className="space-y-6">
        <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
          ...
          <p className="text-sm text-indigo-700">
            Inverters, transformers, switchgear, and power conditioning equipment for energy
            systems.
          </p>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded">
              ...
              <ul className="mt-2 space-y-1 ml-4 list-disc">
                ...
                <li>
                  Updates vendor-specific pricing data (Dynapower, Sinexcel, Great Power,
                  Mainspring)
                </li>
  ...
  const renderSectionContent = () => {
    switch (activeSection) {
      ...
      case "bess":
        return renderBESSSection();
      case "solar":
        return renderSolarSection();
      case "wind":
        return renderWindSection();
      case "generators":
        return renderGeneratorSection();
      case "powerElectronics":
        return renderPowerElectronicsSection();
      case "systemControls":
        return renderSystemControlsSection();
      case "evCharging":
        return renderEVChargingSection();
      case "balanceOfPlant":
        return renderBalanceOfPlantSection();
      default:
