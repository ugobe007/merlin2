  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-amber-400 to-orange-600 text-white p-6 rounded-t-2xl">
        ...
        <div className="p-8">
          ...
          <div className="space-y-4 mb-6">
            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded">
              <h4 className="font-bold text-orange-900 mb-2">Maximize Renewable Energy</h4>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded">
              <h4 className="font-bold text-orange-900 mb-2">Reduce Carbon Footprint</h4>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded">
              <h4 className="font-bold text-orange-900 mb-2">Enable Grid Decarbonization</h4>
            ...
            <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded">
              <h4 className="font-bold text-orange-900 mb-2">Energy Independence</h4>
          ...
          <div className="space-y-4 mb-6">
            <div className="bg-amber-50 p-4 rounded-lg border-2 border-amber-400">
              <h4 className="font-bold text-amber-900 mb-2 text-xl">30% Federal Investment Tax Credit (ITC)</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-orange-600 mb-2">✓ ESG Reporting</div>
              <p className="text-gray-600">Demonstrate environmental commitment to stakeholders</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-orange-600 mb-2">✓ Brand Value</div>
              <p className="text-gray-600">Enhance reputation with sustainability leadership</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-orange-600 mb-2">✓ Future-Proof</div>
              <p className="text-gray-600">Prepare for carbon pricing and regulations</p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-orange-600 mb-2">✓ Certifications</div>
          ...
          <button 
            ...
            className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-amber-600 hover:to-orange-700 transition-colors flex items-center justify-center gap-3"
          >
