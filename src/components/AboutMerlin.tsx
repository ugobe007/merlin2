      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed opacity-95">
                We built Merlin to help people save money with energy and to build a path to a zero
                carbon future. Our platform uses industry-standard formulas and the latest price
                sheets to calculate optimal configurations using AI that delivers real-time quotes
                and configurations guided by industry experts.
              </p>
            </div>
          </div>
          <div className="border-t border-white/20 pt-6 mt-6">
            <p className="text-lg leading-relaxed opacity-95">
              <strong>We believe in transparency.</strong> We're open about energy configurations
              and pricing because we want to help you make clear, well-informed decisions about your
              energy needs.
            </p>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              The Merlin Energy team brings decades of combined experience from the world's leading
              energy, automotive, and technology companies. Our backgrounds span across:
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4 p-4 bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Advanced battery chemistry and materials science
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Lithium-ion battery manufacturing and innovation
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Electric vehicle systems and large-scale energy integration
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Automotive engineering and manufacturing excellence
                  </p>
                </div>
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Building comprehensive Energy Storage Systems that integrate seamlessly with
                existing infrastructure while maximizing efficiency and return on investment.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                From initial assessment to commissioning, we bring end-to-end expertise in Battery
                Energy Storage System development and deployment.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                The Most Important Piece of the Innovation Puzzle
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                After years of working with advanced battery technologies and energy systems, we've
                learned that the most critical innovation isn't just in the hardware—it's in the{" "}
                <strong>right-sizing of energy storage systems</strong> and{" "}
                <strong>accurate pricing of energy needs</strong>.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
              ...
              <ul className="space-y-2 text-gray-700 ml-6">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Oversized systems</strong> that drive up costs unnecessarily
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-600 font-bold mt-1">•</span>
                  <span>
                    <strong>Undersized systems</strong> that fail to meet actual energy demands
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-600 font-bold mt-1">•</span>
                  <span>
                    <strong>Inaccurate pricing</strong> that leads to unrealistic expectations
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-600 font-bold mt-1">•</span>
                  <span>
                    <strong>Lack of transparency</strong> that prevents informed decision-making
                  </span>
                </li>
              </ul>
              <p className="text-lg text-gray-700 leading-relaxed mt-4">
                Merlin Energy was built to solve these fundamental challenges by combining
                AI-powered optimization with real-world industry expertise and transparent,
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Our platform analyzes your specific use case, energy patterns, and goals to
                recommend the optimal system configuration—not too big, not too small, but exactly
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Every quote is based on current market prices from NREL and DOE benchmarks. No
                hidden costs, no surprises—just clear, honest pricing you can trust and verify.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  <span className="text-green-500 mt-1">✓</span>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white rounded-lg p-6 border border-blue-200 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Every number links to NREL ATB, DOE, or EIA sources
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-emerald-200 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Export JSON metadata with all assumptions for due diligence
                </p>
              </div>
              <div className="bg-white rounded-lg p-6 border border-purple-200 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Third parties can independently check without calling us
                </p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl p-12 text-white shadow-2xl">
          ...
          <p className="text-lg leading-relaxed mb-4 opacity-95">
            Energy storage is the key enabler of renewable energy integration. By helping businesses
            and organizations right-size their energy storage investments, we're accelerating the
            transition to clean energy while ensuring economic viability.
          </p>
          <p className="text-lg leading-relaxed opacity-95">
            Every optimized BESS installation is a step toward grid stability, reduced emissions,
            and energy independence. Together, we're not just saving money—we're building a
            sustainable future.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Experience the Merlin difference with a free, no-obligation quote powered by our AI
            platform and backed by decades of industry expertise.
          </p>
          <button
            onClick={() => {
              if (onStartWizard) {
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Stay updated with the latest in energy storage technology, industry insights, and
                Merlin news.
              </p>
