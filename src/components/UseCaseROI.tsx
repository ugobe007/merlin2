            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4">
              <div className="flex justify-between items-center">
                ...
                <div className="text-2xl font-bold text-red-700">
                  $
                  {(
                    (currentUseCase.demandChargeBefore + currentUseCase.energyCostBefore) /
                    1000
                  ).toFixed(0)}
                  K
                </div>
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4">
              <div className="flex justify-between items-center">
                ...
                <div className="text-2xl font-bold text-green-700">
                  $
                  {(
                    (currentUseCase.demandChargeAfter + currentUseCase.energyCostAfter) /
                    1000
                  ).toFixed(0)}
                  K
                </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-4">
              <div className="text-center">
                ...
                <div className="text-xs text-blue-600 mt-1">
                  {(
                    (currentUseCase.totalAnnualSavings /
                      (currentUseCase.demandChargeBefore + currentUseCase.energyCostBefore)) *
                    100
                  ).toFixed(0)}
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
            ...
            <div className="grid grid-cols-1 gap-4 mb-6">
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-600 to-violet-700 text-white rounded-2xl shadow-lg">
                <div className="text-5xl font-bold mb-2">{currentUseCase.roi25Year}</div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-200">
              ...
              <div className="grid grid-cols-1 gap-2">
                <div className="flex justify-between items-center p-2 bg-blue-50/50 rounded-lg border border-blue-200/60">
                  ...
                  <span className="text-sm font-bold text-blue-600">4× 150kW (600kW total)</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-blue-50/50 rounded-lg border border-blue-200/60">
                  <span className="text-sm text-gray-700 font-medium">Level 2 Chargers</span>
                  <span className="text-sm font-bold text-blue-600">8× 7kW (56kW total)</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-blue-50/50 rounded-lg border border-blue-200/60">
                ...
                <div className="flex justify-between items-center p-2 bg-purple-50/50 rounded-lg border border-purple-200/60">
                  ...
                  <span className="text-sm font-bold text-purple-600">681kW</span>
                </div>
              </div>
            </div>
          )}
          ...
          {onLoadTemplate && (
            <button
              onClick={() => {
                ...
                if (import.meta.env.DEV) {
                  console.log(
                    "🎯 setShowPowerAdjustmentModal available:",
                    !!setShowPowerAdjustmentModal
                  );
                }
                if (import.meta.env.DEV) {
                  console.log(
                    "🎯 setSelectedUseCaseForAdjustment available:",
                    !!setSelectedUseCaseForAdjustment
                  );
                }
                if (import.meta.env.DEV) {
