/* Merlin Energy — MERLIN outputs section
  TrueQuote and ProQuote are framed as deliverables generated by the agent. */

import { CheckCircle2, ArrowRight } from "lucide-react";

const TRUEQUOTE_IMG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663452998285/mKEEa8r3K6343KtBgXXzFc/merlin-truequote-card-cpJmBRRXhYFbZrmHadSGfP.png";
const PROQUOTE_IMG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663452998285/mKEEa8r3K6343KtBgXXzFc/merlin-proquote-card-Pkbm64BS4o6epafAMmSoof.png";
const SHIELD_GOLD =
...
const trueQuoteOutcomes = [
  "Savings, cost, and ROI summary",
  "Recommended system configuration",
  "Tariff and incentive assumptions",
  "RFP-ready owner brief",
  "Shareable decision record",
];

const proQuoteOutcomes = [
  "Vendor-ready proposal package",
  "Standardized assumptions",
  "Bid-ready scope and pricing logic",
  "Project pipeline handoff",
];
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        <div className="flex items-start gap-8 mb-16">
          ...
          <div>
            ...
            >
              TrueQuote and ProQuote are not separate stories. They are the customer and vendor
        ...
        <div className="grid lg:grid-cols-[3fr_2fr] gap-5">
          ...
          <div className="card-glass rounded-2xl overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
            ...
            <div className="p-8 lg:p-10">
              ...
              <p
                ...
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
                TrueQuote is the owner-facing Energy Brief MERLIN produces first: savings, project
          ...
          >
            ...
            <div className="p-7 flex flex-col flex-1">
              ...
              <p
                className="text-slate-300 text-sm mb-6 leading-relaxed flex-1"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
                ProQuote turns the MERLIN brief into a standardized vendor package so EPCs,
                developers, and engineers can respond with cleaner assumptions and less proposal
                friction.
              </p>
