 ...
 * Phase 1G Part 2c Operation 1 (Feb 2026)
 *
 * Sticky financial metrics panel with real-time KPIs
 * Extracted from AdvancedQuoteBuilder.tsx (~300 lines)
 *
 * Features:
 * - Sticky positioning (top-[64px])
 * - Backdrop blur with accent gradient
 * - 8 financial KPIs: Total, After ITC, $/kWh, Payback, Savings, ROI
 * - Live update indicator
 * - System badge (MW/hours)
 * - Responsive overflow scroll
 */

export interface LiveFinancialSummaryStripProps {
  financialMetrics: {
