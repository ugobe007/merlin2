        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="hidden lg:block">
            <PowerProfileTracker
              ...
              systemSize={centralizedState.calculated.totalPeakDemandKW || wizardState.batteryKW}
              systemKWh={centralizedState.calculated.recommendedBatteryKWh || wizardState.batteryKWh}
              durationHours={centralizedState.calculated.recommendedBackupHours || wizardState.durationHours}
