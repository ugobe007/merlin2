...
export const INTERNATIONAL_REGIONS: InternationalRegion[] = [
  { code: 'UK', name: 'United Kingdom', flag: '🇬🇧', avgSolarHours: 3.5, avgRate: 0.28 },
  { code: 'DE', name: 'Germany', flag: '🇩🇪', avgSolarHours: 3.2, avgRate: 0.32 },
  { code: 'FR', name: 'France', flag: '🇫🇷', avgSolarHours: 4.0, avgRate: 0.18 },
  { code: 'ES', name: 'Spain', flag: '🇪🇸', avgSolarHours: 5.5, avgRate: 0.22 },
  { code: 'IT', name: 'Italy', flag: '🇮🇹', avgSolarHours: 4.8, avgRate: 0.24 },
  { code: 'AU', name: 'Australia', flag: '🇦🇺', avgSolarHours: 5.8, avgRate: 0.25 },
  { code: 'NZ', name: 'New Zealand', flag: '🇳🇿', avgSolarHours: 4.2, avgRate: 0.22 },
  { code: 'JP', name: 'Japan', flag: '🇯🇵', avgSolarHours: 3.8, avgRate: 0.26 },
  { code: 'IN', name: 'India', flag: '🇮🇳', avgSolarHours: 5.5, avgRate: 0.08 },
  { code: 'AE', name: 'UAE', flag: '🇦🇪', avgSolarHours: 6.5, avgRate: 0.08 },
  { code: 'SA', name: 'Saudi Arabia', flag: '🇸🇦', avgSolarHours: 6.2, avgRate: 0.05 },
];
