...
import { Sparkles, TrendingUp, Sun, Battery, Info, Zap, Clock } from "lucide-react";
...
> = {
  ...
  warehouse: {
    ...
    avgAnnualKWh: 1_000_000,
    peakShavingPercent: 0.3,
    solarFitPercent: 0.45,
    backupValueMultiplier: 0.6,
    typicalBESSKW: 150,
    typicalSolarKW: 300,
  },
  restaurant: {
    avgPeakKW: 100,
    avgAnnualKWh: 300_000,
    peakShavingPercent: 0.3,
    solarFitPercent: 0.3,
    backupValueMultiplier: 0.9,
    typicalBESSKW: 50,
    typicalSolarKW: 75,
  },
  agriculture: {
    avgPeakKW: 200,
    avgAnnualKWh: 500_000,
    peakShavingPercent: 0.35,
    solarFitPercent: 0.5,
    backupValueMultiplier: 0.7,
    typicalBESSKW: 100,
...
export function calculateSavingsPreview(
  ...
  const backupValue = Math.round(averages.avgPeakKW * 100 * averages.backupValueMultiplier);
...
export function SavingsPreviewPanel({
  ...
  onChangeIndustry: _onChangeIndustry,
}: Props) {
  // Calculate estimate
        ...
        <div className="grid grid-cols-5 gap-2 mb-3">
          <div className="bg-white/5 rounded-lg p-2 text-center border border-white/10/50">
            ...
            <p className="text-cyan-300 font-bold text-sm">
              ~{formatCurrency(preview.peakShavingSavings)}
            </p>
          ...
          <div className="bg-white/5 rounded-lg p-2 text-center border border-white/10/50">
            ...
            <p className="text-amber-300 font-bold text-sm">
              ~{formatCurrency(preview.solarPotential)}
            </p>
          ...
          <div className="bg-white/5 rounded-lg p-2 text-center border border-white/10/50">
            ...
            <p className="text-green-300 font-bold text-sm">
              ~{formatCurrency(preview.backupValue)}
            </p>
        ...
        <div className="flex items-center justify-center gap-4 mb-3 py-2 px-3 bg-white/5/60 rounded-lg border border-white/10/50">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-300 text-sm">
              BESS:{" "}
              <span className="text-green-300 font-semibold">~{preview.typicalBESSKW} kW</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-300 text-sm">
              Solar:{" "}
              <span className="text-amber-300 font-semibold">~{preview.typicalSolarKW} kW</span>
            </span>
          </div>
          <div className="w-px h-4 bg-slate-600" />
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-300 text-sm">
              Duration: <span className="text-yellow-300 font-semibold">4 hrs</span>
            </span>
          </div>
        </div>
