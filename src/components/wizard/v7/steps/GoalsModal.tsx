        ...
        <div className="bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden">
          ...
          <div className="relative px-8 pt-8 pb-6 border-b border-slate-800">
            ...
            <div className="flex items-center gap-4 mb-4">
              <img src={merlinIcon} alt="Merlin" className="w-16 h-16 rounded-xl" />
              <div>
                <h2 className="text-3xl font-bold text-white">What are your energy goals?</h2>
                <p className="text-slate-400 text-sm mt-1">Select all that apply</p>
              </div>
            </div>
          </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="font-semibold text-white mb-0.5">{option.label}</div>
          ...
          <div className="p-6 border-t border-slate-800 flex items-center justify-between gap-4">
            ...
            <button
              ...
              `}
              aria-label={
                canContinue ? "Continue to industry selection" : "Select at least one goal"
              }
            >
              {canContinue ? "Continue → Industry" : "Select at least one goal"}
            </button>
          </div>
        </div>
      </div>
