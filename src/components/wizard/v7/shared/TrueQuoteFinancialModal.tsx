          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
            {summaryCards.map((card, i) => (
              ...
              >
                ...
                {card.subtext && (
                  <p className="text-[11px] text-slate-600 mt-0.5">{card.subtext}</p>
                )}
              </div>
            ))}
          </div>
                ...
                <thead>
                  ...
                  >
                    {["Year", "Annual Savings", "Cumulative", "Status"].map((h, i) => (
                      <th
                        key={h}
                        className={`px-4 py-2.5 text-[11px] font-semibold text-slate-500 uppercase tracking-wider ${i === 0 ? "text-left" : i === 3 ? "text-center" : "text-right"}`}
                      >
                        {h}
                      </th>
                    ))}
                ...
                <thead>
                  ...
                  >
                    {["Scenario", "Payback", "NPV", "IRR", "Change"].map((h, i) => (
                      <th
                        key={h}
                        className={`px-4 py-2.5 text-[11px] font-semibold text-slate-500 uppercase ${i === 0 ? "text-left" : "text-right"}`}
                      >
                        {h}
                      </th>
                    ))}
