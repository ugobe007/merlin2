...
interface SaveScenarioModalProps {
  ...
  onSave: (
    name: string,
    options: { isBaseline?: boolean; tags?: string[]; notes?: string }
  ) => Promise<void>;
      ...
      <div className="w-full max-w-lg bg-slate-900 border border-white/10 rounded-xl shadow-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Compare this quote with other options</p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"
            />
          </div>
          ...
          <div className="flex items-center justify-between p-3 rounded-lg bg-white/5">
            <div>
              ...
              <p className="text-xs text-slate-400">Use this as the reference for comparisons</p>
            </div>
            <button
              type="button"
              onClick={() => setIsBaseline(!isBaseline)}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                isBaseline ? "bg-blue-500" : "bg-slate-700"
              }`}
            >
              <span
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30 resize-none"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 p-6 border-t border-white/10">
          ...
          <button
            ...
            className="flex-1 px-4 py-2.5 rounded-lg bg-gradient-to-r from-blue-500 to-violet-500 text-white font-bold hover:from-blue-600 hover:to-violet-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
