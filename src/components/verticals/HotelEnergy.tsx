/**
 * HOTEL ENERGY — Slim Config-Driven Landing Page
 * ================================================
 * 
 * Routes: /hotelenergy, /hotel
 * Replaces: _deprecated/HotelEnergy.legacy.tsx (1,812 lines)
 * 
 * Now powered by shared VerticalLandingPage + hotel config.
 * 
 * NOTE: The legacy page had a `window.location.href = '/wizard?industry=hotel'`
...
export default function HotelEnergy() {
  const config = getVerticalConfig('hotel');
