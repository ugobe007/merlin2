              ...
              <div className="space-y-3">
                {services.map((service, index) => (
                  ...
                  >
                    ...
                    <div
                      className={`px-4 py-2 rounded-lg font-bold flex items-center gap-2 ${getStatusColor(service.status)}`}
                    >
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-bold uppercase ${getSeverityColor(incident.severity)}`}
                            >
                              {incident.severity}
                            </span>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-300 rounded-xl p-6">
              ...
              <div className="bg-white rounded-lg p-4 border border-yellow-300">
                ...
                <div className="text-sm text-gray-700 space-y-1">
                  ...
                  <p>
                    <strong>Time:</strong> 2:00 AM - 3:00 AM UTC
                  </p>
                  <p>
                    <strong>Expected Impact:</strong> Platform will be in read-only mode. Quote
