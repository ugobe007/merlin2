...
const TEST_CASES: TestCase[] = [
  // OFFICE
  {
    ...
    expectedPowerMW: { min: 0.05, max: 0.08 },
  ...
  },
  {
    ...
    expectedPowerMW: { min: 0.12, max: 0.18 },
    expectedDurationHrs: 4,
  },
  {
    ...
    expectedPowerMW: { min: 0.5, max: 0.7 },
    expectedDurationHrs: 4,
  },
  ...
  // HOTEL
  {
    ...
    slug: "hotel",
    inputs: { roomCount: 50 },
    expectedPowerMW: { min: 0.15, max: 0.2 },
    expectedDurationHrs: 4,
  },
  {
    ...
    expectedPowerMW: { min: 0.45, max: 0.6 },
    expectedDurationHrs: 4,
  },
  {
    ...
    expectedPowerMW: { min: 1.2, max: 1.6 },
    expectedDurationHrs: 4,
  },
  ...
  // HOSPITAL
  {
    ...
    slug: "hospital",
    inputs: { bedCount: 100 },
    expectedPowerMW: { min: 0.8, max: 1.2 },
  ...
  },
  {
    ...
    slug: "hospital",
    inputs: { bedCount: 500 },
    expectedPowerMW: { min: 4.5, max: 5.5 },
    expectedDurationHrs: 8,
  },

  // DATA CENTER
  {
    name: "Small DC (100 racks)",
    slug: "datacenter",
    inputs: { rackCount: 100, rackDensityKW: 8 },
    expectedPowerMW: { min: 1.0, max: 1.5 },
    expectedDurationHrs: 4,
  },
  {
    name: "Medium DC (400 racks)",
    slug: "datacenter",
    inputs: { rackCount: 400, rackDensityKW: 8 },
    expectedPowerMW: { min: 4.0, max: 5.5 },
    expectedDurationHrs: 4,
  },

  // EV CHARGING
  {
    name: "Small EV (4 L2, 2 DC)",
    slug: "ev-charging",
    inputs: { numberOfLevel2Chargers: 4, numberOfDCFastChargers: 2 },
    expectedPowerMW: { min: 0.35, max: 0.45 },
    expectedDurationHrs: 2,
  },
  {
    name: "Large EV Hub (20 L2, 10 DC)",
    slug: "ev-charging",
    inputs: { numberOfLevel2Chargers: 20, numberOfDCFastChargers: 10 },
    expectedPowerMW: { min: 1.8, max: 2.0 },
    expectedDurationHrs: 2,
  },
  ...
  // AGRICULTURE
  {
    ...
    expectedPowerMW: { min: 0.15, max: 0.25 },
    expectedDurationHrs: 4,
  },
  {
    ...
    expectedPowerMW: { min: 1.8, max: 2.5 },
    expectedDurationHrs: 4,
  },

  // MANUFACTURING
  {
    name: "Light Mfg (50k sq ft)",
    slug: "manufacturing",
    inputs: { facilitySqFt: 50000, industryType: "light" },
    expectedPowerMW: { min: 0.4, max: 0.6 },
    expectedDurationHrs: 4,
  },
  {
    name: "Heavy Mfg (100k sq ft)",
    slug: "manufacturing",
    inputs: { facilitySqFt: 100000, industryType: "heavy" },
    expectedPowerMW: { min: 2.0, max: 3.0 },
    expectedDurationHrs: 4,
  },

  // WAREHOUSE
  {
    name: "Warehouse (250k sq ft)",
    slug: "warehouse",
    inputs: { warehouseSqFt: 250000 },
    expectedPowerMW: { min: 0.4, max: 0.6 },
    expectedDurationHrs: 4,
  },
  {
    name: "Cold Storage (100k sq ft)",
    slug: "cold-storage",
    inputs: { storageVolume: 100000 },
    expectedPowerMW: { min: 0.7, max: 0.9 },
    expectedDurationHrs: 8,
  },

  // RETAIL
  {
    name: "Small Retail (5k sq ft)",
    slug: "retail",
    inputs: { retailSqFt: 5000 },
    expectedPowerMW: { min: 0.03, max: 0.05 },
    expectedDurationHrs: 4,
  },
  {
    name: "Shopping Mall (500k sq ft)",
  ...
  // CASINO
  {
    name: "Casino (50k gaming)",
    slug: "casino",
    inputs: { gamingFloorSize: 50000 },
    expectedPowerMW: { min: 0.8, max: 1.0 },
    expectedDurationHrs: 4,
  },

  // INDOOR FARM
  {
    name: "Vertical Farm (20k sq ft)",
    slug: "indoor-farm",
  ...
  // APARTMENTS
  {
    name: "Apartments (200 units)",
    slug: "apartment",
    inputs: { unitCount: 200 },
    expectedPowerMW: { min: 0.3, max: 0.4 },
    expectedDurationHrs: 4,
  },

  // COLLEGE
  {
    name: "College (5k students)",
    slug: "college",
  ...
  // CAR WASH
  {
    name: "Car Wash (6 bays)",
    slug: "car-wash",
    inputs: { bayCount: 6, washType: "automatic" },
    expectedPowerMW: { min: 0.1, max: 0.15 },
    expectedDurationHrs: 2,
  },

  // AIRPORT
  {
    name: "Airport (5M passengers)",
    slug: "airport",
    inputs: { annualPassengers: 5 },
    expectedPowerMW: { min: 6.5, max: 8.5 },
    expectedDurationHrs: 4,
  },
];
...
function runTests(): void {
  ...
  for (const test of TEST_CASES) {
    ...
    const powerOK =
      result.powerMW >= test.expectedPowerMW.min && result.powerMW <= test.expectedPowerMW.max;
    ...
    if (powerOK && durationOK) {
      ...
      console.log(
        `   ${result.powerMW.toFixed(3)} MW [${test.expectedPowerMW.min}-${test.expectedPowerMW.max}] | ${result.durationHrs}hr`
      );
    } else {
      failed++;
      const error = !powerOK
