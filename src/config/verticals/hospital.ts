...
export const hospitalConfig: VerticalConfig = {
  ...
  carouselImages: [
    {
      ...
      subcaption: "Always-on power required",
    },
    {
      src: hosp2,
      alt: "Hospital Power Systems",
      caption: "Backup Power",
      subcaption: "Seamless failover",
    },
    {
      src: hosp3,
      alt: "Hospital Exterior",
      caption: "Healthcare Facility",
  ...
  heroStats: [
    { value: "$300K", label: "Avg Savings/Year" },
    { value: "8–12yr", label: "Payback Period" },
  ...
  calculator: {
    inputs: [
      ...
      {
        id: "hasChillerPlant",
        label: "Has Central Chiller Plant",
        type: "toggle",
        defaultValue: true,
      },
      {
  ...
  quickEstimate: (inputs) => {
    ...
    // $1,500/bed/yr reflects demand charge savings on typical 5-10 kW/bed peak load
    // at $20/kW demand charge × 75% BESS effectiveness + solar contribution.
    // Payback of ~10yr reflects generator NEC 517 requirement adding resilience cost.
    const savingsPerBed = 1500;
    return { savings: savingsPerBed * beds, payback: 10.0, label: `${beds} bed facility` };
  },
  ...
  howItWorks: [
    {
      title: "Describe Your Hospital",
      description: "Enter bed count, critical systems, and location. Takes about 60 seconds.",
    },
    {
      title: "Merlin Designs Your System",
      description:
        "Our AI sizes BESS per NEC 517/NFPA 99 standards with IEEE 446 critical load percentages.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Connect with certified healthcare power integrators. Instant backup + ongoing demand charge savings.",
    },
  ],
  ...
  metaDescription:
    "BESS solutions for hospitals. NEC 517/NFPA 99 compliant backup power with 40% demand charge savings. Free quote in 60 seconds.",
};
