...
export const carWashConfig: VerticalConfig = {
  ...
  carouselImages: [
    {
      src: carWashPitStop,
      alt: "PitStop Car Wash",
      caption: "Professional Service",
      subcaption: "Industry-leading results",
    },
    {
      src: carWashPitStop1,
      alt: "PitStop Express Bay",
      caption: "Express Tunnel",
      subcaption: "High-volume efficiency",
    },
    {
      src: carWashPitStop2,
      alt: "PitStop Premium Service",
      caption: "Premium Detailing",
      subcaption: "Superior customer experience",
    },
    {
      src: carWashPitStop3,
      alt: "PitStop Wash System",
      caption: "Advanced Equipment",
      subcaption: "Energy-intensive operations",
    },
    {
      src: carWashPitStop4,
      alt: "PitStop Operations",
      caption: "Streamlined Process",
      subcaption: "Optimized for savings",
    },
    {
      src: carWashPitStop5,
      alt: "PitStop Full Service",
      caption: "Full Service Wash",
      subcaption: "Complete car care",
    },
    {
      src: carWashPreen,
      alt: "Preen Car Wash",
      caption: "Modern Facility",
      subcaption: "Next-gen technology",
    },
    {
      src: carWashTunnel,
      alt: "Modern Car Wash Tunnel",
    ...
    },
    {
      ...
      subcaption: "Consistent quality results",
    },
    {
      src: carWashImage,
      alt: "Car Wash Interior",
      caption: "Efficient Operations",
      subcaption: "Optimized for savings",
    },
  ],
  heroCallout: {
  ...
  howItWorks: [
    {
      title: "Tell Us About Your Car Wash",
      description: "Enter your bay count, equipment, and location. Takes about 60 seconds.",
    },
    {
      title: "Merlin Analyzes Your Needs",
      description:
        "Our AI uses NREL ATB 2024 pricing and DOE-aligned methodology to design the optimal battery storage system.",
    },
    {
      title: "Get Your Custom Quote",
      description:
        "Receive a detailed proposal with ROI projections, equipment specs, and traceable cost sources.",
    },
    {
      title: "Start Saving Money",
      description:
        "Connect with certified installers and start cutting your energy costs immediately.",
    },
  ],
  ...
  metaDescription:
    "Battery storage solutions for car washes. Cut demand charges, reduce energy costs, and keep washing during outages. Free quote in 60 seconds.",
};
