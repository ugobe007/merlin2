      ...
      <div className="max-w-5xl mx-auto px-4 py-16 space-y-16">
        ...
        <div className="text-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight leading-[1.1]">
            BESS quotes in{" "}
            <span className="text-[#3ECF8E]" style={{ textShadow: "0 0 40px rgba(62,207,142,0.3)" }}>
              60 seconds
            </span>
            <br />
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
            ...
            Every quote is TrueQuote™ verified — every number traces to a published
            source. No consultants. No spreadsheets. Free.
          </p>
        ...
        <div className="grid sm:grid-cols-2 gap-2">
          {FEATURES.map((f) => (
            <div key={f} className="flex items-start gap-3 px-4 py-3 rounded-xl bg-white/[0.02] border border-white/[0.05]">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                I built Merlin because every BESS quote I saw was a black box —
                opaque assumptions, hardcoded spreadsheets, $5K+ consultant fees.
                TrueQuote™ means you can see exactly where every number comes from.
                NREL said $X/kWh. IRA 2022 says 30% ITC. IEEE 446-1995 says your
                critical load is 40% of peak. All of it, cited. All of it, free.
              </p>
              <div className="mt-3 flex items-center gap-4 flex-wrap">
                ...
                <a href="/press" className="text-xs text-slate-500 hover:text-[#3ECF8E] transition-colors">
                  Press &amp; promo kit →
                </a>
        ...
        <div className="text-center py-8">
          ...
          <p className="text-slate-500 mb-6 text-sm">No account needed. Your first quote takes under 90 seconds.</p>
          <a href="/wizard"
