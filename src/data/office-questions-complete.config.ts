...
export const officeQuestionsComplete: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'planned', label: 'Planned / Considering', icon: '📋', description: 'Co-locate solar + BESS for best ROI' },
      { value: 'none', label: 'No Solar Yet', icon: '🔌', description: 'BESS alone still cuts demand charges' },
    ],
    smartDefault: 'none',
    validation: { required: true },
  ...
  },
  {
    ...
    suffix: 'kW',
    smartDefault: 200,
    helpText: 'Office buildings typically have 50-500 kW of rooftop solar. Check your inverter rating or solar monitoring app.',
