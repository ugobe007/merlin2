...
export const VENDORS: Record<string, VendorInfo> = {
  ...
  tesla: {
    ...
    country: "USA",
    description:
      "World's largest fast-charging network with Supercharger and Wall Connector products",
  ...
  legrand: {
    ...
    country: "France",
    description:
      "Commercial and residential EV charging with Pass & Seymour and AmpUp platform integration",
    partnership: "distributor",
  },
  "enel-x": {
    id: "enel-x",
  ...
  kempower: {
    ...
    country: "Finland",
    description:
      "Modular DC fast charging with dynamic power management for fleets and public charging",
    partnership: "none",
  },
  ...
  "great-power": {
    ...
    country: "China",
    description:
      "Tier-1 LFP battery cell and ESS container manufacturer for utility and C&I storage",
  ...
  byd: {
    ...
    country: "China",
    description:
      "Vertically integrated battery manufacturer with BYD Cube and MC Cube ESS solutions",
    partnership: "authorized",
  },
  "tesla-energy": {
    id: "tesla-energy",
    ...
    country: "USA",
    description:
      "Megapack and Powerwall battery energy storage for utility and commercial applications",
    partnership: "distributor",
  },
  fluence: {
    id: "fluence",
  ...
  sungrow: {
    ...
    country: "China",
    description:
      "Global leading inverter and ESS supplier with comprehensive C&I and utility solutions",
    partnership: "authorized",
  },
  sma: {
    id: "sma",
    ...
    country: "Germany",
    description:
      "Premium solar inverters and energy management for commercial and utility applications",
    partnership: "authorized",
  },
  ...
  cummins: {
    ...
    country: "USA",
    description:
      "Global leader in diesel and natural gas generator sets for backup and prime power",
    partnership: "authorized",
  },
  mainspring: {
    id: "mainspring",
...
export const EV_CHARGER_PRODUCTS: EVChargerProduct[] = [
  // ── ChargePoint ──────────────────────────────────────
  {
    ...
    model: "CPF50",
    description:
      "Commercial Level 2 charging station with dual ports, RFID access, and ChargePoint cloud management. Ideal for workplace, retail, and hospitality charging.",
  ...
  },
  {
    ...
    model: "CP6000",
    description:
      "Next-generation commercial Level 2 station with power management, load balancing, and sleek design for workplace and retail environments.",
    chargerLevel: "level-2",
    powerKW: 19.2,
    connectors: ["J1772"],
    simultaneousCharging: 2,
  ...
  },
  {
    ...
    model: "CPE250",
    description:
      "Modular DC fast charging platform delivering up to 500 kW with dynamic power management. Powers entire charging plazas from a single power block.",
    chargerLevel: "dcfc",
    powerKW: 250,
  ...
  // ── Tesla ────────────────────────────────────────────
  {
    ...
    model: "Gen 3",
    description:
      "Sleek Level 2 home and commercial charger with WiFi connectivity. Works with all EVs via J1772 adapter or NACS-native Tesla vehicles.",
    chargerLevel: "level-2",
    powerKW: 19.2,
    connectors: ["NACS"],
  ...
  },
  {
    ...
    model: "V4",
    description:
      "Latest-generation Tesla Supercharger with Magic Dock (CCS1 + NACS compatibility), delivering up to 250 kW. Open to all EVs with CCS adapter.",
    chargerLevel: "dcfc",
    powerKW: 250,
  ...
  },
  {
    ...
    model: "Universal",
    description:
      "Level 2 wall charger with both NACS and J1772 connectors, compatible with all EVs. Ideal for commercial properties serving mixed EV fleets.",
    chargerLevel: "level-2",
    powerKW: 19.2,
  ...
  // ── ABB ──────────────────────────────────────────────
  {
    ...
    description:
      "Commercial Level 2 AC wallbox with RFID authentication and OCPP connectivity. Robust design for workplace and fleet charging applications.",
    chargerLevel: "level-2",
    powerKW: 22,
  ...
  },
  {
    ...
    model: "Terra 360",
    description:
      "The world's fastest all-in-one EV charger — up to 360 kW with dynamic power distribution across up to 4 vehicles simultaneously.",
    chargerLevel: "hpc",
    powerKW: 360,
  ...
  // ── Tritium ──────────────────────────────────────────
  {
    ...
    model: "RTM75",
    description:
      "Ultra-compact 75 kW DC fast charger with the smallest footprint in its class. Ideal for space-constrained locations and urban installations.",
    chargerLevel: "dcfc",
    powerKW: 75,
  ...
  },
  {
    ...
    model: "PK350",
    description:
      "Scalable high-power DC fast charger delivering up to 350 kW. Modular architecture allows field-upgradeable power levels from 75 kW to 350 kW.",
    chargerLevel: "hpc",
    powerKW: 350,
    connectors: ["CCS1", "CCS2", "CHAdeMO"],
    simultaneousCharging: 2,
  ...
  // ── Legrand ──────────────────────────────────────────
  {
    ...
    model: "EVP2PM",
    description:
      "Commercial pedestal-mount Level 2 charger with AmpUp network integration. Clean design with dual connectors for parking lots and multi-family properties.",
    chargerLevel: "level-2",
    powerKW: 11.5,
    connectors: ["J1772"],
    simultaneousCharging: 2,
  ...
  // ── Siemens ──────────────────────────────────────────
  {
    ...
    model: "VC30GRYU",
    description:
      "Commercial Level 2 charger with RFID access, OCPP network management, and Siemens reliability. Ideal for fleets, workplaces, and multi-tenant properties.",
    chargerLevel: "level-2",
    powerKW: 11.5,
    connectors: ["J1772"],
    simultaneousCharging: 1,
  ...
  // ── Kempower ─────────────────────────────────────────
  {
    ...
    model: "S-Series",
    description:
      "Modular DC fast charging system with dynamic power management. One power unit can serve multiple satellites, optimizing infrastructure costs for fleet and public charging.",
    chargerLevel: "dcfc",
    powerKW: 200,
    connectors: ["CCS1", "CCS2"],
...
export const EQUIPMENT_PRODUCTS: VendorProduct[] = [
  // ── BESS Products ────────────────────────────────────
  {
    ...
    category: "battery",
    name: "Great Power Ultra MAX 5000 ESS Container",
    description:
      "Containerized outdoor BESS, 2,508–5,016 kWh per 20ft unit. LFP chemistry, integrated liquid cooling/heating, active forced ventilation, and aerosol+sprinkler fire suppression. Scalable to 6 independent DC buses.",
    specs: {
      Chemistry: "LFP/LiFePO₄",
      "Energy Range": "2,508–5,016 kWh per container",
      Models: "MAX-2508 / MAX-2508-LV / MAX-3344 / MAX-3762 / MAX-4180 / MAX-4598 / MAX-5016",
      "Cell Capacity": "314 Ah",
      "Nominal Voltage": "665.6–1,332 V DC (model-dependent)",
      "Voltage Range": "540.8–1,497.6 V DC",
      "Max Charge/Discharge Current": "1,158 A",
      "Nominal Charge/Discharge Current": "942 A",
      "Cycle Life": "10,000 cycles",
      "Round-Trip Efficiency": "93.5%",
      "IP Rating": "IP55",
      "Thermal Management": "Integrated Liquid Cooling and Heating System",
      "Fire Suppression":
        "Fire Suppression, Heat and Smoke Detection, Deflagration Panel, Sprinkler",
      "Operating Temperature": "-22°F to 132.8°F (-30°C to 55°C)",
      "Discharge Temperature": "-22°F to 132.8°F (-30°C to 55°C)",
      "Charge Temperature": "32°F to 132.8°F (0°C to 55°C)",
      Altitude: "≤13,123 ft (≤4,000 m)",
      Noise: "≤80 dB",
      Communications: "ModbusTCP (Ethernet) and Modbus RTU",
      Length: "238.50 in (6,058 mm)",
      Width: "95.98 in (2,438 mm)",
      Height: "114.02 in (2,896 mm)",
      "Weight (lb)": "59,436–97,003 (model-dependent)",
      Scalability: "Up to 6 independent DC buses and connections",
      Warranty: "20 years or 10,000 cycles",
    },
    features: [
      "Factory-assembled and pre-tested container — minimal on-site install time",
      "10,000-cycle LFP cell life (20-year warranty)",
      "93.5% round-trip efficiency",
      "Integrated liquid cooling and heating for -30°C to 55°C operation",
      "Active forced ventilation + battery/electrical compartment isolation",
      "Aerosol fire suppression + overall fire sprinkler system",
      "Up to 6 independent DC buses — flexible AC/DC architecture",
      "Compatible with 1,000–1,500 Vdc inverters, 220–800 Vac output",
      "IP55 outdoor rated",
    ],
    certifications: [
      "UL9540",
    ...
    warranty: "20 years or up to 10,000 cycles",
    images: [
      {
        filename: "great_power_container_01.jpg",
        alt: "Great Power Ultra MAX 5000 containerized BESS",
        caption: "Great Power Ultra MAX 5000 — 2,508–5,016 kWh LFP Container",
        isPrimary: true,
        approved: false,
        source: "vendor-website",
      },
  ...
  },
  {
    ...
    specs: {
      ...
      "Cell Configuration": "1P52S → 1P416S (model-dependent)",
      "Cell Capacity": "320 Ah",
      "Nominal Voltage": "166 V (UTL-52) — 1,331 V (UTL-418)",
      "High/Low Voltage Range": "187/135 V (UTL-52) — 1,498/1,082 V (UTL-418)",
      "Max Charge/Discharge Current": "173 A",
      "Nominal Charge/Discharge Current": "157 A",
      "Cycle Life": "10,000 cycles",
      "Round-Trip Efficiency": "96%",
      "IP Rating": "NEMA 3R / IP55",
      "Thermal Management": "Integrated Liquid Cooling and Heating of LFP Battery Module Cells",
      "Fire Suppression": "Fire Suppression, Heat and Smoke Detection, Deflagration Panel",
      "Operating Temperature": "-31°F to 131°F (-35°C to 55°C)",
      "Discharge Temperature": "-0.4°F to 132.8°F (-18°C to 56°C)",
      "Charge Temperature": "35.6°F to 132.8°F (2°C to 56°C)",
      Altitude: "≤6,562 ft (≤2,000 m)",
      Noise: "≤75 dB",
      "Cabinet Scalability": "Up to 15 cabinets / 6.4 MWh",
      Communications: "ModbusTCP (Ethernet) and Modbus RTU",
      "Dimensions (L×W×H)": "51.18 × 51.18 × 92.71 in (1,300 × 1,300 × 2,355 mm)",
      "Weight (lb)": "3,075 (UTL-52) — 8,395 (UTL-418)",
      "Inverter Compatibility": "150–1,500 Vdc input; 220V, 480V, 690Vac, 800V output",
      BMS: "Multi-tiered Battery Management System",
      Warranty: "20 years or 10,000 cycles",
    },
    features: [
      ...
      "10,000-cycle / 20-year warranty",
      "Integrated liquid cooling AND heating — full -35°C to 55°C operating envelope",
      "NEMA 3R / IP55 outdoor rated — no separate enclosure needed",
      "High-safety LiqPACK design to prevent thermal runaway",
      "Deflation plate design compliant with NFPA855",
      "Aerosol fire suppression system",
      "Multi-tiered BMS",
      "Compatible with 150–1,500 Vdc inverters",
    ],
    certifications: [
      "UL1973",
      "UL9540A",
    ...
    images: [
      {
        filename: "great_power_magna_utl_01.jpg",
        alt: "Great Power MAGNA-UTL energy storage cabinet",
        caption: "Great Power MAGNA-UTL — 52–418 kWh LFP Cabinet (C&I)",
        isPrimary: true,
        approved: false,
        source: "vendor-website",
      },
  ...
  },
  {
    ...
    name: "CATL EnerC",
    description:
      "Compact commercial and industrial BESS with CATL's Cell-to-Pack technology. High energy density in a space-efficient form factor.",
    specs: {
      Chemistry: "LFP",
  ...
  },
  {
    ...
    model: "Megapack 2 XL",
    description:
      "Utility-scale BESS with 4 MWh capacity per unit. Fully integrated with inverter, thermal management, and AC-connected design for simplified installation.",
    specs: {
      Chemistry: "LFP",
  ...
  // ── Inverter / PCS Products ──────────────────────────
  {
    ...
    model: "SC5000UD-MV",
    description:
      "Utility-scale storage inverter with 5 MW capacity and 1500V DC input. High efficiency with advanced grid-forming capabilities.",
    specs: {
      "Max Power": "5 MW",
      "DC Voltage": "1500V",
      Efficiency: "> 98.8%",
  ...
  // ── Generator Products ───────────────────────────────
  {
    ...
    model: "C200D6R",
    description:
      "Reliable 200 kW diesel generator set for standby power applications. Integrated digital controls with remote monitoring capability.",
    specs: {
  ...
  },
  {
    ...
    model: "LG460",
    description:
      "Revolutionary linear generator that converts natural gas to electricity without combustion. Ultra-low emissions and fuel-flexible (natural gas, hydrogen, biogas).",
    specs: {
...
export const ALL_PRODUCTS: VendorProduct[] = [...EV_CHARGER_PRODUCTS, ...EQUIPMENT_PRODUCTS];
