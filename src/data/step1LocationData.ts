...
export const STATE_ELECTRICITY_RATES: Record<string, number> = {
  // 50 States
  'AL': 0.1465, 'AK': 0.2212, 'AZ': 0.1225, 'AR': 0.1075, 'CA': 0.2372,
  'CO': 0.1135, 'CT': 0.2518, 'DE': 0.1280, 'DC': 0.2012, 'FL': 0.1188,
  'GA': 0.1185, 'HI': 0.3643, 'ID': 0.0935, 'IL': 0.1313, 'IN': 0.1468,
  'IA': 0.0986, 'KS': 0.1098, 'KY': 0.1233, 'LA': 0.1208, 'ME': 0.2176,
  'MD': 0.1385, 'MA': 0.2320, 'MI': 0.1423, 'MN': 0.1199, 'MS': 0.1331,
  'MO': 0.0957, 'MT': 0.1128, 'NE': 0.0889, 'NV': 0.0839, 'NH': 0.1978,
  'NJ': 0.1565, 'NM': 0.1108, 'NY': 0.2014, 'NC': 0.1061, 'ND': 0.0707,
  'OH': 0.1125, 'OK': 0.0812, 'OR': 0.1145, 'PA': 0.1203, 'RI': 0.2453,
  'SC': 0.1101, 'SD': 0.1076, 'TN': 0.1362, 'TX': 0.0900, 'UT': 0.0967,
  'VT': 0.1994, 'VA': 0.0902, 'WA': 0.1152, 'WV': 0.1208, 'WI': 0.1282, 'WY': 0.0908,
  // US Territories (estimated commercial rates)
  'PR': 0.2350, 'VI': 0.3500, 'GU': 0.3100, 'AS': 0.2800, 'MP': 0.2900
};
...
export const STATE_SUNSHINE_HOURS: Record<string, number> = {
  'AL': 4.8, 'AK': 3.2, 'AZ': 6.5, 'AR': 4.7, 'CA': 5.8, 'CO': 5.5, 'CT': 4.0, 'DE': 4.2, 'DC': 4.2, 'FL': 5.4,
  'GA': 4.9, 'HI': 5.5, 'ID': 4.9, 'IL': 4.2, 'IN': 4.1, 'IA': 4.4, 'KS': 5.0, 'KY': 4.2, 'LA': 4.8, 'ME': 4.0,
  'MD': 4.3, 'MA': 4.0, 'MI': 3.9, 'MN': 4.3, 'MS': 4.8, 'MO': 4.5, 'MT': 4.6, 'NE': 4.8, 'NV': 6.2, 'NH': 4.0,
  'NJ': 4.2, 'NM': 6.4, 'NY': 3.9, 'NC': 4.7, 'ND': 4.4, 'OH': 4.0, 'OK': 5.2, 'OR': 4.2, 'PA': 4.0, 'RI': 4.0,
  'SC': 4.9, 'SD': 4.7, 'TN': 4.5, 'TX': 5.4, 'UT': 5.6, 'VT': 3.9, 'VA': 4.4, 'WA': 3.8, 'WV': 4.0, 'WI': 4.1, 'WY': 5.1,
  // US Territories
  'PR': 5.5, 'VI': 5.8, 'GU': 5.2, 'AS': 5.0, 'MP': 5.3
};
...
export function getDefaultCityForState(stateCode: string): string {
  const defaults: Record<string, string> = {
    ...
    'MO': 'Saint Louis', 'MT': 'Billings', 'NE': 'Omaha', 'NV': 'Las Vegas', 'NH': 'Manchester',
    ...
    'VT': 'Burlington', 'VA': 'Richmond', 'WA': 'Seattle', 'WV': 'Charleston', 'WI': 'Milwaukee',
    'WY': 'Cheyenne', 'PR': 'San Juan', 'VI': 'Charlotte Amalie', 'GU': 'Hagatna', 'AS': 'Pago Pago',
    'MP': 'Saipan', 'AP': 'APO'
  };
