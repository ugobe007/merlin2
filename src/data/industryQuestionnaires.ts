    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "custom", label: "⚙️ Custom - I know my exact rates" },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          { value: "50", label: "🏘️ 50% (Suburban/Medium Traffic)" },
          { value: "70", label: "🏙️ 70% (Urban/High Traffic)" },
          { value: "85", label: "🛣️ 85% (Highway/Travel Centers)" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: "limited", label: "⚠️ Limited Grid (Capacity constraints)" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: "custom", label: "⚙️ Custom hours" },
        ],
      },
    ],
    insights: {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { value: "hangar", label: "🛩️ Hangar/Maintenance" },
          { value: "ground-ops", label: "🚜 Ground Operations" },
          { value: "full-airport", label: "✈️ Full Airport Complex" },
        ],
      },
      {
        id: "operationSize",
