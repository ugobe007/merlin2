...
export const gasStationQuestionsComplete: Question[] = [
  ...
  },
  {
    ...
    options: [
      { value: 'cost', label: 'Reduce Energy Costs', icon: '💰' },
      { value: 'ev-enablement', label: 'Enable EV Charging', icon: '🔌', description: 'Add chargers without grid upgrade' },
      { value: 'resilience', label: 'Business Continuity', icon: '🛡️', description: 'Keep pumps running in outages' },
      { value: 'future-proof', label: 'Future-Proof Business', icon: '🚀', description: 'Prepare for EV transition' },
    ],
    smartDefault: 'cost',
    validation: { required: true },
