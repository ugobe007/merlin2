...
export const USE_CASE_TEMPLATES: UseCaseTemplate[] = [
  // ==================== CAR WASH ====================
  {
    ...
    customQuestions: [
      ...
      },
      {
        ...
        impactType: "none",
        helpText:
          "Optional: Your actual peak load from utility bill (leave 0 for auto-calculation)",
        required: false,
      },
      {
        id: "gridConnection",
      ...
      },
      {
        ...
        impactType: "factor",
        helpText:
          "If limited grid: Enter max capacity from utility. If 0, we assume unlimited grid.",
        required: false,
      },
    ],
  },
  ...
  // ==================== EV CHARGING STATION ====================
  {
    ...
    slug: "ev-charging",
    description:
      "EV charging stations have high peak demand with fast charging requirements. BESS reduces demand charges and enables grid arbitrage.",
    icon: "⚡",
    ...
    financialParams: {
      ...
      incentives: {
        clean_energy: 0.3, // Federal Section 30C tax credit (30% with prevailing wage)
        transportation: 0.15, // State/utility EV infrastructure incentives
        nevi_funding: 0.8, // NEVI Formula Program covers up to 80% of project costs
      },
    },
    ...
    customQuestions: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "limited",
            label: "Limited Capacity - Need utility upgrade to support chargers",
          },
  ...
  // ==================== HOSPITAL ====================
  {
    ...
    slug: "hospital",
    description:
      "Hospitals require 24/7 reliable power with critical backup systems. BESS provides demand charge reduction and backup power.",
    icon: "🏥",
    image: hospitalImage,
    ...
    recommendedApplications: ["peak_shaving", "backup_power", "demand_response", "load_shifting"],
  ...
  // ==================== INDOOR FARM ====================
  {
    ...
    slug: "indoor-farm",
    description:
      "Indoor farms operate 24/7 with constant high loads from grow lights, HVAC, and irrigation. Excellent BESS ROI due to continuous operation.",
    icon: "🌱",
    ...
    financialParams: {
      ...
      incentives: {
        agriculture: 0.2, // CORRECTED: Enhanced agricultural incentives for food security
        sustainability: 0.15, // CORRECTED: Green building and sustainable agriculture credits
        rural_development: 0.1, // CORRECTED: Rural economic development incentives
      },
    },
    ...
    customQuestions: [
      {
        ...
        impactType: "multiplier",
        impactsField: "equipmentPower",
        multiplierValue: 0.04, // CORRECTED: 40W per sq ft for modern vertical farms
  ...
  // ==================== HOTEL ====================
  {
    ...
    slug: "hotel",
    description:
      "Hotels have variable loads with morning/evening peaks. BESS reduces demand charges and provides backup power for critical systems.",
    icon: "🏨",
    ...
    equipment: [
      ...
      },
      {
        ...
        description:
          "Restaurant kitchen, banquet facilities, room service (NSF commercial standards)",
      },
      {
    ...
    financialParams: {
      ...
      incentives: {
        ...
        clean_energy: 0.1, // CORRECTED: Green building certification incentives
      },
    },
    ...
    customQuestions: [
      ...
      },
      {
        ...
        impactType: "factor",
        helpText:
          "Hotel category affects energy intensity. Star ratings define service level, facilities, and guest expectations. Luxury properties (4-5 star) typically use 50-70% more energy per room than budget hotels.",
        required: true,
      },
      {
        id: "averageOccupancy",
        ...
        impactType: "factor",
        helpText:
          "Occupancy drives variable loads (HVAC, laundry, food service). Industry average is 60-75%",
        required: true,
      },
      {
        id: "hasRestaurant",
      ...
      },
      {
        ...
        helpText:
          "Backup power maintains operations during outages - important for guest satisfaction",
        required: true,
      },
      {
        id: "priorityGoals",
  ...
  // ==================== AIRPORT ====================
  {
    ...
    slug: "airport",
    description:
      "Airports are critical infrastructure with 24/7 operations, making them ideal for BESS to manage peak demand and ensure power reliability.",
    icon: "✈️",
    image: airportImage,
    category: "institutional",
    ...
    equipment: [
      ...
      },
      {
        ...
        dutyCycle: 0.4, // CORRECTED: Used during aircraft servicing
    ...
    financialParams: {
      ...
      incentives: {
        ...
        faa_modernization: 0.1, // CORRECTED: FAA NextGen infrastructure modernization funding
      },
    },
  ...
  // ==================== COLLEGE/UNIVERSITY ====================
  {
    ...
    description:
      "Educational institutions have predictable schedules with high daytime loads. BESS provides cost savings and educational opportunities.",
    icon: "🎓",
    category: "institutional",
    requiredTier: "semi_premium",
    isActive: true,
    ...
    equipment: [
      ...
      },
      {
        ...
        dutyCycle: 0.9, // CORRECTED: Near-continuous operation for campus connectivity
      ...
      },
      {
        ...
        dutyCycle: 0.7, // CORRECTED: Residential loads with extended operation
    ...
    financialParams: {
      ...
      incentives: {
        education: 0.3, // CORRECTED: Higher educational institution incentives
    ...
    customQuestions: [
      ...
      },
      {
        ...
        impactType: "factor",
        helpText:
          "Institution type affects research intensity and specialized facility requirements",
        required: true,
      },
      {
      ...
      },
      {
        ...
        impactType: "factor",
        helpText:
          "Research intensity significantly affects laboratory and specialized equipment loads",
        required: true,
      },
      {
        id: "facilitySize",
  ...
  // ==================== DENTAL OFFICE ====================
  {
    ...
    slug: "dental-office",
    description:
      "Dental practices have moderate energy needs with specialized medical equipment. BESS provides backup power and demand charge reduction.",
    icon: "🦷",
    ...
    recommendedApplications: ["peak_shaving", "backup_power", "load_shifting"],
  ...
  // ==================== OFFICE BUILDING ====================
  {
    ...
    description:
      "Commercial office buildings have moderate energy needs driven by HVAC, lighting, and office equipment. BESS provides demand charge reduction and backup power during outages.",
    icon: "🏢",
    category: "commercial",
    requiredTier: "free",
    isActive: true,
  ...
  // ==================== EDGE DATA CENTER ====================
  {
    ...
    slug: "data-center",
    description:
      "Data centers require 24/7 uptime with massive power demands. BESS provides backup power, peak shaving, and grid services revenue.",
    icon: "💾",
    category: "commercial",
    requiredTier: "premium",
    isActive: true,
    ...
    equipment: [
      ...
      },
      {
        ...
        dutyCycle: 0.9, // CORRECTED: Near-continuous operation for thermal management
      ...
      },
      {
        ...
        dutyCycle: 0.8, // CORRECTED: Extended hours for security monitoring
    ...
    financialParams: {
      ...
      incentives: {
        critical_infrastructure: 0.2, // CORRECTED: Critical infrastructure incentives
        ...
        edge_computing: 0.1, // CORRECTED: Edge infrastructure development incentives
      },
    },
    ...
    customQuestions: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "limited",
            label: "Limited Capacity - Grid undersized (needs local generation)",
          },
  ...
  // ==================== FOOD PROCESSING PLANT ====================
  {
    ...
    description:
      "Food processing facilities have critical refrigeration loads and production schedules. BESS protects product quality and reduces costs.",
    icon: "🏭",
    category: "industrial",
    requiredTier: "premium",
    isActive: true,
    ...
    equipment: [
      ...
      },
      {
        ...
        dutyCycle: 0.7, // CORRECTED: Production shift patterns
      ...
      },
      {
        ...
        dutyCycle: 0.8, // CORRECTED: Support systems for production
    ...
    financialParams: {
      ...
      incentives: {
        ...
        clean_energy: 0.1, // CORRECTED: Clean energy adoption in manufacturing
      },
    },
  ...
  // ==================== APARTMENT COMPLEX ====================
  {
    ...
    slug: "apartments",
    description:
      "Multi-family residential complexes have predictable daily patterns and growing EV charging needs. BESS reduces costs and adds amenities.",
    icon: "🏢",
    ...
    equipment: [
      {
        ...
        dutyCycle: 0.6, // CORRECTED: Varies by season and occupancy
      ...
      },
      {
        ...
        dutyCycle: 0.4, // CORRECTED: Peak usage during commute times
      ...
      },
      {
        ...
        dutyCycle: 0.3, // CORRECTED: Overnight and weekend charging patterns
    ...
    financialParams: {
      ...
      incentives: {
        ...
        affordable_housing: 0.2, // CORRECTED: If qualifying affordable housing
  ...
  // ==================== GAS STATION/C-STORE ====================
  {
    ...
    slug: "gas-station",
    description:
      "Convenience stores and fuel stations with refrigeration, pumps, and lighting. BESS reduces demand charges and provides backup power.",
    icon: "⛽",
    category: "commercial",
    requiredTier: "free",
    isActive: true,
    ...
    customQuestions: [
      {
        ...
        type: "select",
        default: "with-cstore",
        options: ["gas-only", "with-cstore", "truck-stop"],
        impactType: "factor",
      ...
      },
      {
        ...
        type: "select",
        default: "reliable",
        options: ["reliable", "unreliable", "limited", "off_grid", "microgrid"],
        impactType: "factor",
        helpText: "Grid quality affects backup requirements and generation needs",
        required: true,
      },
  ...
  // ==================== TRIBAL CASINO ====================
  {
    ...
    slug: "tribal-casino",
    description:
      "24/7 gaming and hospitality operations with mission-critical power needs. BESS ensures uninterrupted gaming, reduces demand charges, and supports energy sovereignty.",
    icon: "🎰",
    category: "commercial",
    requiredTier: "semi_premium",
    isActive: true,
    ...
    customQuestions: [
      {
        ...
        options: ["casino-only", "casino-hotel", "resort-complex"],
        impactType: "factor",
      ...
      },
      {
        ...
        options: ["maximum-independence", "cost-savings", "hybrid"],
        impactType: "design_priority",
  ...
  // ==================== WAREHOUSE/DISTRIBUTION ====================
  {
    ...
    slug: "warehouse",
    description:
      "Distribution centers with material handling, climate control, and EV fleet charging. BESS reduces peak demand costs and manages EV charging loads.",
    icon: "📦",
    category: "commercial",
    requiredTier: "free",
    isActive: true,
    ...
    customQuestions: [
      {
        ...
        options: ["storage", "distribution", "cold-storage", "fulfillment", "mixed"],
        impactType: "factor",
      ...
      },
      {
        ...
        type: "select",
        default: "none",
        options: ["none", "existing", "high-potential", "planned"],
        impactType: "solar_flag",
  ...
  // ==================== GOVERNMENT BUILDING ====================
  {
    ...
    slug: "government",
    description:
      "Municipal and government facilities with critical operations, resilience requirements, and sustainability mandates. BESS provides backup power and cost savings.",
    icon: "🏛️",
    category: "commercial",
    requiredTier: "free",
    isActive: true,
    ...
    customQuestions: [
      {
        ...
        type: "select",
        default: "office",
        options: ["city-hall", "office", "library", "police-fire", "community-center", "school"],
        impactType: "factor",
  ...
  // ==================== LOGISTICS CENTER ====================
  {
    ...
    description:
      "Large-scale distribution hubs with high-volume operations, automation, and EV fleets. BESS optimizes energy costs and manages fleet charging.",
    icon: "🚚",
    category: "commercial",
    requiredTier: "semi_premium",
    isActive: true,
    ...
    customQuestions: [
      ...
      },
      {
        ...
        type: "select",
        default: "moderate",
        options: ["manual", "moderate", "highly-automated"],
        impactType: "factor",
  ...
  // ==================== MANUFACTURING ====================
  {
    ...
    slug: "manufacturing",
    description:
      "Industrial manufacturing with production equipment, motors, and process systems. BESS reduces high demand charges and improves power quality.",
    icon: "🏭",
    category: "industrial",
    requiredTier: "semi_premium",
    isActive: true,
  ...
  // ==================== AGRICULTURE ====================
  {
    ...
    slug: "agriculture",
    description:
      "Agricultural operations with irrigation, processing, and storage. BESS enables time-of-use optimization and supports off-grid operation.",
    icon: "🚜",
    category: "agricultural",
    requiredTier: "free",
    isActive: true,
    ...
    customQuestions: [
      {
        ...
        type: "select",
        default: "crop",
        options: ["row-crop", "dairy", "greenhouse", "orchard", "vineyard", "processing", "mixed"],
        impactType: "factor",
  ...
  // ==================== RETAIL STORE ====================
  {
    ...
    slug: "retail",
    description:
      "Retail stores benefit from demand charge reduction through peak shaving during business hours. BESS provides backup power for refrigeration and POS systems.",
    icon: "🛒",
    category: "commercial",
    requiredTier: "free",
    isActive: true,
    ...
    customQuestions: [
      {
        ...
        type: "select",
        default: "general",
        options: ["grocery", "big-box", "strip-mall", "shopping-center", "restaurant", "general"],
        impactType: "factor",
  ...
  // ==================== SHOPPING CENTER ====================
  {
    ...
    description:
      "Retail centers have predictable operating hours with high HVAC and lighting loads. BESS reduces demand charges and provides tenant savings.",
    icon: "🛒",
    category: "commercial",
    requiredTier: "free",
    isActive: true,
    ...
    equipment: [
      {
        ...
        dutyCycle: 0.7, // CORRECTED: Operating hours + pre-cooling/heating
      ...
      },
      {
        ...
        dutyCycle: 0.6, // CORRECTED: Varies by tenant type and operating hours
      ...
      },
      {
        ...
        dutyCycle: 0.8, // CORRECTED: Extended hours for shopper convenience
    ...
    financialParams: {
      ...
      roiAdjustmentFactor: 0.9, // CORRECTED: Stable retail cash flows support good ROI
      ...
      incentives: {
        ...
        retail: 0.1, // CORRECTED: Retail sector incentives
 ...
 */
export function getUseCasesForTier(
  tier: "free" | "semi_premium" | "premium" | "admin"
): UseCaseTemplate[] {
  const tierHierarchy = { free: 0, semi_premium: 1, premium: 2, admin: 3 };
  const userTierLevel = tierHierarchy[tier];

  return USE_CASE_TEMPLATES.filter((uc) => {
