...
export const STEP1_GOALS: Goal[] = [
  { id: 'costs', icon: '✂️', label: 'Cut Energy Costs', description: 'Reduce monthly electricity bills' },
  { id: 'backup', icon: '🔋', label: 'Backup Power', description: 'Stay powered during outages' },
  { id: 'sustainability', icon: '🌱', label: 'Sustainability', description: 'Reduce carbon footprint' },
  { id: 'independence', icon: '🏠', label: 'Grid Independence', description: 'Less reliance on utilities' },
