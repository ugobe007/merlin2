...
export const agricultureQuestionsComplete: Question[] = [
  ...
  },
  {
    ...
    options: [
      { value: 'cost', label: 'Reduce Pump / Energy Costs', icon: '💰' },
      { value: 'resilience', label: 'Irrigation Reliability', icon: '🛡️', description: 'Pump during outages' },
      { value: 'off-grid', label: 'Remote / Off-Grid Power', icon: '🏜️', description: 'Power where grid doesn\'t reach' },
      { value: 'sustainability', label: 'Sustainable Agriculture', icon: '🌿', description: 'Carbon footprint reduction' },
    ],
    smartDefault: 'cost',
    validation: { required: true },
    impactsCalculations: ['bessMode', 'bessCapacity'],
