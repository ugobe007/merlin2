...
export const STATE_UTILITY_DATA: Record<string, StateUtilityDataRecord> = {
  Alabama: {
    utilityName: "Alabama Power",
    electricityRate: 0.117,
    demandChargePerKW: 12,
    peakRate: 0.14,
    offPeakRate: 0.08,
  },
  Alaska: {
    utilityName: "Chugach Electric",
    electricityRate: 0.201,
  ...
  Arizona: {
    utilityName: "APS / SRP",
    electricityRate: 0.112,
    demandChargePerKW: 18,
    peakRate: 0.22,
    offPeakRate: 0.07,
  },
  Arkansas: {
    utilityName: "Entergy Arkansas",
    electricityRate: 0.09,
    demandChargePerKW: 11,
    peakRate: 0.11,
    offPeakRate: 0.07,
  },
  California: {
    utilityName: "PG&E / SCE / SDG&E",
    electricityRate: 0.221,
    demandChargePerKW: 25,
    peakRate: 0.45,
    offPeakRate: 0.12,
  },
  Colorado: {
    ...
    electricityRate: 0.112,
    demandChargePerKW: 14,
    peakRate: 0.16,
    offPeakRate: 0.08,
  },
  Connecticut: {
    utilityName: "Eversource",
    electricityRate: 0.196,
    demandChargePerKW: 20,
    peakRate: 0.28,
    offPeakRate: 0.12,
  },
  Delaware: {
    utilityName: "Delmarva Power",
    electricityRate: 0.109,
    demandChargePerKW: 13,
    peakRate: 0.15,
    offPeakRate: 0.09,
  },
  Florida: {
    utilityName: "FPL / Duke Energy",
    electricityRate: 0.113,
    demandChargePerKW: 12,
    peakRate: 0.18,
    offPeakRate: 0.08,
  },
  ...
  Hawaii: {
    utilityName: "Hawaiian Electric",
    electricityRate: 0.369,
  ...
  Illinois: {
    utilityName: "ComEd / Ameren",
    electricityRate: 0.111,
    demandChargePerKW: 14,
    peakRate: 0.18,
    offPeakRate: 0.07,
  },
  Indiana: {
    utilityName: "Duke Energy Indiana",
    electricityRate: 0.113,
    demandChargePerKW: 12,
    peakRate: 0.14,
    offPeakRate: 0.08,
  ...
  Iowa: {
    utilityName: "MidAmerican Energy",
    electricityRate: 0.109,
    demandChargePerKW: 11,
    peakRate: 0.13,
    offPeakRate: 0.07,
  ...
  Kentucky: {
    utilityName: "LG&E / Kentucky Utilities",
    electricityRate: 0.102,
    demandChargePerKW: 11,
    peakRate: 0.12,
    offPeakRate: 0.07,
  },
  Louisiana: {
    utilityName: "Entergy Louisiana",
  ...
  Maine: {
    utilityName: "Central Maine Power",
    electricityRate: 0.157,
    demandChargePerKW: 15,
    peakRate: 0.2,
    offPeakRate: 0.1,
  },
  Maryland: {
    utilityName: "BGE / Pepco",
  ...
  Massachusetts: {
    utilityName: "National Grid / Eversource",
    electricityRate: 0.195,
    demandChargePerKW: 22,
    peakRate: 0.3,
    offPeakRate: 0.12,
  },
  Michigan: {
    utilityName: "DTE Energy / Consumers",
    electricityRate: 0.143,
    demandChargePerKW: 16,
    peakRate: 0.2,
    offPeakRate: 0.09,
  },
  Minnesota: {
  ...
  Missouri: {
    utilityName: "Ameren Missouri",
    electricityRate: 0.101,
    demandChargePerKW: 12,
    peakRate: 0.14,
    offPeakRate: 0.07,
  },
  Montana: {
    ...
    electricityRate: 0.105,
    demandChargePerKW: 10,
    peakRate: 0.12,
    offPeakRate: 0.07,
  },
  Nebraska: {
    utilityName: "OPPD / NPPD",
    electricityRate: 0.1,
    demandChargePerKW: 11,
    peakRate: 0.12,
    offPeakRate: 0.07,
  ...
  "New Hampshire": {
    utilityName: "Eversource NH",
    electricityRate: 0.174,
    demandChargePerKW: 18,
    peakRate: 0.22,
    offPeakRate: 0.11,
  },
  "New Jersey": {
    utilityName: "PSE&G / JCP&L",
    electricityRate: 0.137,
    demandChargePerKW: 17,
    peakRate: 0.22,
    offPeakRate: 0.09,
  },
  "New Mexico": {
  ...
  "New York": {
    utilityName: "ConEd / National Grid",
    electricityRate: 0.168,
    demandChargePerKW: 22,
    peakRate: 0.35,
    offPeakRate: 0.08,
  },
  "North Carolina": {
    utilityName: "Duke Energy Carolinas",
    electricityRate: 0.099,
    demandChargePerKW: 12,
    peakRate: 0.15,
    offPeakRate: 0.07,
  },
  "North Dakota": {
    utilityName: "Xcel Energy / MDU",
  ...
  Ohio: {
    utilityName: "AEP Ohio / FirstEnergy",
    electricityRate: 0.111,
    demandChargePerKW: 13,
    peakRate: 0.16,
    offPeakRate: 0.08,
  ...
  Oklahoma: {
    utilityName: "OG&E / PSO",
    electricityRate: 0.092,
    demandChargePerKW: 11,
    peakRate: 0.14,
    offPeakRate: 0.06,
  },
  Oregon: {
    utilityName: "PGE / Pacific Power",
    electricityRate: 0.102,
    demandChargePerKW: 11,
    peakRate: 0.15,
    offPeakRate: 0.07,
  ...
  "Rhode Island": {
    utilityName: "Rhode Island Energy",
    electricityRate: 0.191,
    demandChargePerKW: 20,
    peakRate: 0.28,
    offPeakRate: 0.12,
  },
  "South Carolina": {
    utilityName: "Duke Energy / SCE&G",
    electricityRate: 0.104,
    demandChargePerKW: 12,
    peakRate: 0.14,
    offPeakRate: 0.07,
  },
  "South Dakota": {
    utilityName: "Xcel Energy / Black Hills",
    electricityRate: 0.106,
    demandChargePerKW: 10,
    peakRate: 0.13,
    offPeakRate: 0.07,
  },
  Tennessee: {
    utilityName: "TVA Distributors",
    electricityRate: 0.102,
    demandChargePerKW: 11,
    peakRate: 0.13,
    offPeakRate: 0.07,
  ...
  Utah: {
    utilityName: "Rocky Mountain Power",
  ...
  Virginia: {
    ...
    electricityRate: 0.107,
    demandChargePerKW: 13,
    peakRate: 0.16,
    offPeakRate: 0.07,
  },
  Washington: {
    utilityName: "Puget Sound Energy",
    electricityRate: 0.097,
    demandChargePerKW: 11,
    peakRate: 0.13,
    offPeakRate: 0.07,
  },
  "West Virginia": {
    utilityName: "Appalachian Power",
    electricityRate: 0.102,
    demandChargePerKW: 11,
    peakRate: 0.13,
    offPeakRate: 0.07,
...
export function getStateUtilityData(state: string): StateUtilityDataRecord {
  ...
  const found = Object.entries(STATE_UTILITY_DATA).find(
    ([key]) =>
...
export function getStateSolarData(state: string): SolarDataRecord {
  ...
  // Try finding partial match
  const found = Object.entries(NREL_SOLAR_DATA).find(
    ([key]) =>
      key.toLowerCase().includes(state.toLowerCase()) ||
      state.toLowerCase().includes(key.toLowerCase())
  );
