 ...
 *   2. Operations (Q5-10)  — itUtilization, coolingSystem, evaporativeCooling, redundancy, rackDensity, requiredRuntime
...
export const datacenterSections: Section[] = [
  {
    ...
    description: "Tier, capacity, and infrastructure",
    icon: "🖥️",
  },
  {
    id: "operations",
    title: "Operations & Cooling",
    description: "IT load, PUE, and redundancy",
    icon: "❄️",
  },
  {
    id: "energy",
    title: "Power & Grid",
    description: "Grid connection and backup systems",
    icon: "⚡",
  },
  {
    id: "solar",
...
export const datacenterQuestionsComplete: Question[] = [
    ...
    options: [
      {
        ...
        label: "Tier I",
        icon: "🟢",
        description: "99.671% uptime — basic, non-redundant",
      },
      {
        value: "tier_2",
        label: "Tier II",
        icon: "🟡",
        description: "99.741% uptime — redundant capacity components",
      },
      {
        value: "tier_3",
        label: "Tier III",
        icon: "🟠",
        description: "99.982% uptime — concurrently maintainable",
      },
      {
        value: "tier_4",
        label: "Tier IV",
        icon: "🔴",
        description: "99.995% uptime — fault-tolerant 2N+1",
      },
    ],
    smartDefault: "tier_3",
    merlinTip:
      "Tier III is the most common for enterprise colocation. Tier IV adds 30-50% to infrastructure cost but provides near-zero downtime.",
  ...
  },
  {
    ...
    smartDefault: "50000",
    merlinTip:
      "A typical enterprise colocation is 25-100K sq ft. Hyperscale campuses exceed 500K sq ft.",
  ...
  },
  {
    ...
    unit: " kW",
    merlinTip:
      "Average rack draws 5-8 kW. High-density AI/GPU racks can draw 30-60 kW each. A 200-rack facility typically needs 1-4 MW.",
  ...
  },
  {
    ...
    options: [
      {
        value: "1.1-1.3",
        label: "Excellent (1.1-1.3)",
        icon: "🟢",
        description: "Modern, highly optimized cooling",
      },
      {
        value: "1.3-1.5",
        label: "Good (1.3-1.5)",
        icon: "🟡",
        description: "Industry average, efficient operations",
      },
      {
        value: "1.5-1.8",
        label: "Average (1.5-1.8)",
        icon: "🟠",
        description: "Older infrastructure, room to improve",
      },
      {
        value: "1.8-2.5",
        label: "Poor (1.8-2.5)",
        icon: "🔴",
        description: "Significant cooling inefficiency",
      },
    ],
    smartDefault: "1.3-1.5",
    merlinTip:
      "Google runs at 1.10 PUE. Industry average is ~1.58. Every 0.1 PUE reduction saves 5-7% on total energy costs.",
    validation: { required: true },
    ...
    options: [
      {
        ...
        label: "Low (20-40%)",
        icon: "📉",
        description: "Under-utilized, significant headroom",
      },
      {
        value: "40-60%",
        label: "Moderate (40-60%)",
        icon: "📊",
        description: "Typical enterprise deployment",
      },
      {
        value: "60-80%",
        label: "High (60-80%)",
        icon: "📈",
        description: "Well-utilized, planning expansion",
      },
      {
        value: "80-95%",
        label: "Near Capacity (80-95%)",
        icon: "🔥",
        description: "Approaching limits, expansion needed",
      },
    ],
    smartDefault: "60-80%",
    ...
    options: [
      {
        ...
        icon: "💨",
        description: "Traditional raised-floor cooling",
      },
      {
        value: "chilled-water",
        label: "Chilled Water",
        icon: "💧",
        description: "Central plant with chillers",
      },
      {
        value: "liquid",
        label: "Direct Liquid Cooling",
        icon: "🔵",
        description: "Rack-level liquid (GPU/AI workloads)",
      },
      {
        value: "hybrid",
        label: "Hybrid Air + Liquid",
        icon: "🔄",
        description: "Mixed cooling for varied densities",
      },
      {
        value: "free-cooling",
        label: "Free Cooling / Economizer",
        icon: "🌿",
        description: "Air-side economizer (outside air)",
      },
    ],
    smartDefault: "chilled-water",
    merlinTip:
      "Liquid cooling can reduce PUE by 0.2-0.4 vs air cooling. Free cooling works well in cool climates.",
    validation: { required: true },
  ...
  },
  {
    ...
    type: "toggle",
    section: "operations",
    title: "Evaporative (water-side) cooling",
    subtitle:
      "Cooling towers, adiabatic, or swamp/evaporative cooling that rejects heat using water",
    smartDefault: "yes",
    merlinTip:
      "Most legacy data centers rely on evaporative cooling (cooling towers / adiabatic assist). It lowers PUE in dry climates but consumes significant water — Merlin factors this into cooling load and water-usage assumptions.",
    validation: { required: false },
    impactsCalculations: ["coolingLoad", "pue", "waterUsage"],
  },
  {
    id: "redundancy",
    type: "buttons",
    ...
    options: [
      {
        value: "N",
        label: "N (No Redundancy)",
        icon: "1️⃣",
        description: "Single path, any failure = downtime",
      },
      { value: "N+1", label: "N+1", icon: "🔧", description: "One extra component per group" },
      {
        value: "2N",
        label: "2N (Fully Redundant)",
        icon: "🔒",
        description: "Completely parallel systems",
      },
      { value: "2N+1", label: "2N+1", icon: "🛡️", description: "Fully redundant + one spare" },
    ],
    smartDefault: "N+1",
    merlinTip:
      "2N redundancy doubles infrastructure cost but ensures zero single points of failure.",
    validation: { required: true },
    ...
    options: [
      {
        ...
        label: "Low (3-5 kW)",
        icon: "🟢",
        description: "Storage, network, light compute",
      },
      {
        value: "standard",
        label: "Standard (5-10 kW)",
        icon: "🟡",
      ...
      },
      {
        ...
        label: "High (10-20 kW)",
        icon: "🟠",
        description: "Dense compute, moderate GPU",
      },
      {
        value: "ultra",
        label: "Ultra (20-60 kW)",
        icon: "🔴",
        description: "AI/ML training, HPC clusters",
      },
    ],
    smartDefault: "standard",
    merlinTip:
      "AI/GPU racks at 40-60 kW each drive massive cooling and power requirements. A single rack can use as much as a house.",
    validation: { required: false },
    ...
    options: [
      {
        ...
        label: "5 Minutes",
        icon: "⏱️",
        description: "UPS bridge to generator start",
      },
      {
        value: "15min",
        label: "15 Minutes",
        icon: "⏱️",
        description: "Standard UPS + transfer time",
      },
      {
        value: "1hr",
        label: "1 Hour",
        icon: "🕐",
        description: "Extended ride-through for short outages",
      },
      {
        value: "4hr",
        label: "4 Hours",
        icon: "🕓",
        description: "Full BESS backup for grid instability",
      },
      {
        value: "8hr+",
        label: "8+ Hours",
        icon: "🔋",
        description: "Complete grid independence capability",
      },
    ],
    smartDefault: "15min",
    merlinTip:
      "Traditional UPS provides 5-15 min. BESS can extend to 4-8+ hours, replacing generators entirely.",
    validation: { required: true },
  ...
  // ── SECTION 3: ENERGY & GRID (Q10-Q13) ──
  {
    ...
    options: [
      {
        ...
        icon: "🔄",
        description: "Two or more independent utility feeds",
      },
      {
        value: "on-grid",
        label: "Single Feed",
        icon: "🔌",
        description: "Standard single utility connection",
      },
      {
        value: "limited",
        label: "Limited Capacity",
        icon: "⚠️",
        description: "Grid cannot support expansion needs",
      },
      {
        value: "off-grid",
    ...
    merlinTip:
      "Redundant utility feeds are standard for Tier III+. Limited grid capacity is the #1 driver for on-site BESS at data centers.",
    validation: { required: true },
  ...
  },
  {
    ...
    options: [
      { value: "reliable", label: "Very Reliable", icon: "✅", description: "< 1 outage per year" },
      {
        ...
        icon: "⚡",
        description: "2-5 outages per year",
      },
      {
        value: "frequent",
        label: "Frequent Outages",
        icon: "⚠️",
        description: "6+ outages per year",
      },
      {
        value: "unstable",
        label: "Unreliable Grid",
        icon: "🔴",
        description: "Regular brownouts, voltage issues",
      },
    ],
    smartDefault: "reliable",
    merlinTip:
      "Even one 15-minute outage can cost a data center $100K-$1M. BESS provides instant switchover (< 10ms) vs generators (10-30 seconds).",
    validation: { required: true },
  ...
  },
  {
    ...
    options: [
      {
        value: "full",
        label: "Full N+1 Generators",
        icon: "🟢",
        description: "Covers 100%+ of IT load",
      },
      {
        value: "partial",
        label: "Partial Coverage",
        icon: "🟡",
        description: "Covers critical load only",
      },
      {
        value: "none",
        label: "No Generators",
        icon: "❌",
        description: "No backup generation on-site",
      },
    ],
    smartDefault: "full",
    merlinTip:
      "BESS can reduce generator dependency by 40-70%, eliminating fuel logistics, emissions, and maintenance costs.",
    validation: { required: true },
    ...
    options: [
      {
        ...
        label: "Lead-Acid UPS",
        icon: "🔋",
        description: "Traditional VRLA batteries, 5-10 min runtime",
      },
      {
        value: "lithium",
        label: "Lithium UPS",
        icon: "⚡",
        description: "Modern Li-ion UPS, longer runtime",
      },
      {
        value: "flywheel",
        label: "Flywheel",
        icon: "🔄",
        description: "Kinetic energy storage, 15-30 sec",
      },
      { value: "none", label: "No UPS", icon: "❌", description: "No UPS installed" },
    ],
    smartDefault: "lead-acid",
    merlinTip:
      "Replacing lead-acid UPS with lithium BESS can triple runtime, cut floor space 70%, and eliminate toxic battery disposal.",
    validation: { required: false },
    impactsCalculations: ["bessCapacity", "duration"],
  },
    ...
    options: [
      {
        ...
        icon: "☀️",
        description: "Panels on roof or carport",
      },
      {
        value: "planned",
        label: "Planned / Considering",
        icon: "📋",
        description: "Co-locate solar + BESS for best ROI",
      },
      {
        value: "none",
        label: "No Solar",
        icon: "🔌",
        description: "BESS alone provides UPS + peak shaving",
      },
    ],
    smartDefault: "none",
    validation: { required: true },
  ...
  },
  {
    ...
    smartDefault: 500,
    helpText:
      "Data center rooftop or carport solar typically ranges from 200 kW to 2 MW depending on available area.",
