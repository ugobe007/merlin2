...
export const datacenterQuestionsComplete: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'none', label: 'No Solar', icon: '🔌', description: 'BESS alone provides UPS + peak shaving' },
    ],
    smartDefault: 'none',
    validation: { required: true },
  ...
  },
  {
    ...
    suffix: 'kW',
    smartDefault: 500,
    helpText: 'Data center rooftop or carport solar typically ranges from 200 kW to 2 MW depending on available area.',
