...
export const carWashQuestionsComplete: Question[] = [
  ...
  },
  {
    ...
    options: [
      { value: "level2", label: "Level 2", icon: "🔌", description: "7–22 kW each" },
      { value: "dcfast", label: "DC Fast", icon: "⚡", description: "50–150 kW each" },
      { value: "both", label: "Both", icon: "🚗", description: "Mixed fleet" },
    ],
    smartDefault: "level2",
    conditionalLogic: {
