 ...
 */
export function getISOFromState(state: string): 'CAISO' | 'ERCOT' | 'PJM' | 'NYISO' | 'ISO-NE' | 'MISO' | null {
  const isoMapping: Record<string, 'CAISO' | 'ERCOT' | 'PJM' | 'NYISO' | 'ISO-NE' | 'MISO'> = {
    ...
    'WV': 'PJM', 'OH': 'PJM', 'KY': 'PJM', 'NC': 'PJM', 'TN': 'PJM',
    'IN': 'PJM', 'IL': 'PJM', 'MI': 'PJM', 'DC': 'PJM',
    'Pennsylvania': 'PJM', 'New Jersey': 'PJM', 'Maryland': 'PJM',
    'Delaware': 'PJM', 'Virginia': 'PJM', 'West Virginia': 'PJM',
    'Ohio': 'PJM', 'Kentucky': 'PJM', 'North Carolina': 'PJM',
    ...
    // ISO-NE
    'CT': 'ISO-NE', 'MA': 'ISO-NE', 'RI': 'ISO-NE', 'NH': 'ISO-NE',
    'VT': 'ISO-NE', 'ME': 'ISO-NE',
    'Connecticut': 'ISO-NE', 'Massachusetts': 'ISO-NE', 'Rhode Island': 'ISO-NE',
    'New Hampshire': 'ISO-NE', 'Vermont': 'ISO-NE', 'Maine': 'ISO-NE',
    
    // MISO (15 states)
    'MN': 'MISO', 'IA': 'MISO', 'MO': 'MISO', 'WI': 'MISO', 'AR': 'MISO',
    'LA': 'MISO', 'MS': 'MISO', 'ND': 'MISO', 'SD': 'MISO', 'MT': 'MISO',
    'Minnesota': 'MISO', 'Iowa': 'MISO', 'Missouri': 'MISO', 'Wisconsin': 'MISO',
...
export async function calculateTotalAncillaryRevenue(params: {
  ...
  const serviceTypes: Array<'frequency_regulation' | 'spinning_reserves' | 'capacity' | 'energy_arbitrage'> = [
 ...
 */
export async function getFrequencyRegulationPrices(): Promise<Array<{
  iso: string;
