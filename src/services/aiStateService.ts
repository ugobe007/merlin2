    ...
    switch (state) {
      case 'unselected':
        return {
          ...
          icon: '🤖',
          description: usageCount > 0 ? 'Get additional AI insights' : 'Let AI analyze your configuration'
        };
      
      case 'analyzing':
        return {
          className: 'bg-gradient-to-r from-blue-600 to-purple-600 text-white border-2 border-blue-300 ring-4 ring-blue-200',
          text: 'AI Analyzing...',
          icon: '🔍',
      ...
      case 'applied':
        return {
          className: 'bg-gradient-to-r from-green-600 to-emerald-600 text-white border-2 border-green-300 ring-4 ring-green-200',
          text: '✅ AI Applied',
          icon: '✅',
      ...
      default:
        return {
          className: 'bg-gradient-to-r from-purple-600 to-blue-600 text-white border-2 border-transparent hover:from-purple-700 hover:to-blue-700',
