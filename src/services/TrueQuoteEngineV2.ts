...
export async function processQuote(
  ...
  if (import.meta.env.DEV) {
    console.log("═══════════════════════════════════════════════════════");
    console.log("🔷 StackQuote v2: Processing quote request");
    console.log("═══════════════════════════════════════════════════════");
  ...
  if ("rejected" in authResult && authResult.rejected) {
    console.error("❌ StackQuote: Proposal REJECTED");
  ...
  const result: TrueQuoteAuthenticatedResult = {
    ...
    warnings: [],
    notes: [
      `Quote generated by StackQuote Engine v${ENGINE_VERSION}`,
  ...
  if (import.meta.env.DEV) {
    console.log("");
    console.log("═══════════════════════════════════════════════════════");
    console.log("✅ StackQuote v2: Quote authenticated!");
