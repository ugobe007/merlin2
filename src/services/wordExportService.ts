...
import { italicParagraph } from "./wordHelpers";
  ...
  return [
    ...
    new Paragraph({
      children: [
        ...
        new TextRun({
          text: `${data.powerMW}MW / ${data.totalMWh}MWh Battery Energy Storage System`,
        }),
      ],
      spacing: { after: 200 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({
          text: "The financial analysis shows strong economic viability for this BESS project:",
          bold: true,
        }),
      ],
      spacing: { after: 200 },
    ...
    new Paragraph({
      children: [
        new TextRun({
          text: "This BESS design complies with all relevant industry standards:",
          bold: true,
        }),
      ],
      spacing: { after: 200 },
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "3. Execute project agreement and begin detailed engineering" }),
      ],
      spacing: { after: 100 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "For questions or to discuss this proposal further:", bold: true }),
      ],
      spacing: { after: 200 },
    }),
...
function generateAppendixContent(): Paragraph[] {
  return [
    ...
    new Paragraph({
      children: [
        new TextRun({
          text: "• Peak Shaving Savings = Energy × (Peak Rate - Off-peak Rate) × Efficiency",
        }),
      ],
      spacing: { after: 100 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "• Demand Charge Savings = Power × Demand Charge Rate × 12 months" }),
      ],
      spacing: { after: 100 },
    }),
    ...
    new Paragraph({
      children: [new TextRun({ text: "• BNEF Energy Storage Market Outlook 2024", bold: true })],
      spacing: { after: 100 },
    }),
    ...
    new Paragraph({
      children: [new TextRun({ text: "• NREL Cost and Performance Database", bold: true })],
      spacing: { after: 100 },
    }),

    new Paragraph({
      children: [new TextRun({ text: "• EIA Electricity Market Data", bold: true })],
      spacing: { after: 200 },
    }),
