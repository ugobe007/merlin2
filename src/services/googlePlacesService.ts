            ...
            if (place.place_id) {
              ...
              service.getDetails(
                ...
                (
                  ...
                  const finalPlace =
                    detailsStatus === google.maps.places.PlacesServiceStatus.OK && detailedPlace
                      ? detailedPlace
                      : place;
                      ...
                      (
                        ...
                        if (
                          ...
                          const actualBusiness = nearbyResults.find((r) => {
                            ...
                            if (
                              r.name.toLowerCase() === "las vegas" ||
                              r.name.toLowerCase() === "nevada"
                            )
                              return false;
                            ...
                            return (
                              hasKnownType ||
                              (r.types?.includes("establishment") && r.name.length > 3)
                            );
                          });
                          ...
                          if (actualBusiness) {
                            ...
                            if (actualBusiness.photos && actualBusiness.photos.length > 0) {
                              nearbyPhotoUrl = actualBusiness.photos[0].getUrl({
                                maxWidth: 400,
                                maxHeight: 300,
                              });
                            }
                            ...
                            resolve({
                              ...
                              formattedAddress:
                                actualBusiness.vicinity || finalPlace.formatted_address,
                              photoUrl: nearbyPhotoUrl || photoUrl,
                              placeId: actualBusiness.place_id || place.place_id,
                              lat:
                                actualBusiness.geometry?.location?.lat() ||
                                finalPlace.geometry?.location?.lat(),
                              lng:
                                actualBusiness.geometry?.location?.lng() ||
                                finalPlace.geometry?.location?.lng(),
