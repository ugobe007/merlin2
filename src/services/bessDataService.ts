...
export const DEFAULT_BESS_FINANCIAL_INPUTS: BESSFinancialInputs = {
  ...
  // CAPEX (2025 costs based on NREL ATB 2024)
  batteryCostPerMWh: 250000, // $250k/MWh (declining)
  pcsCostPerMW: 150000, // $150k/MW
  bomCostPerMW: 100000, // $100k/MW
  epcCostPerMW: 200000, // $200k/MW
  interconnectionCostPerMW: 50000, // $50k/MW
  developmentCostPercent: 5,
  contingencyPercent: 10,
  
  // OPEX
  operationMaintenanceCostPerMWhPerYear: 15000, // $15k/MWh/year
  insurancePercentOfCapex: 0.5,
  propertyTaxPercentOfCapex: 1.0,
  landLeaseCostPerYear: 50000,
  
  // Revenue
  electricityRatePerMWh: 120, // $120/MWh average
  demandChargePerMWPerMonth: 15000, // $15k/MW/month
  ancillaryServicesRevenuePerMWPerYear: 50000, // $50k/MW/year
  capacityPaymentPerMWPerYear: 30000, // $30k/MW/year
