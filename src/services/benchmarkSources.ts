...
export const AUTHORITATIVE_SOURCES: Record<string, BenchmarkSource> = {
  ...
  "marriott-lancaster-2025": {
    ...
    lastVerified: "2025-12-10",
    notes:
      "First fully solar-powered Marriott in US. 133 rooms, 2,700 panels, 1.239 GWh/year generation, 8,850 kWh/room/year consumption. Verified Dec 2025.",
  },
  ...
  "ieee-4538388": {
    ...
    notes:
      "Foundational paper for optimal BESS sizing. Key finding: peak shaving with 30-50% of peak demand captures most demand charge savings at lowest cost.",
  },
  "mdpi-energies-2048": {
    ...
    lastVerified: "2025-12-11",
    notes:
      "Linear programming methodology for cost-optimal BESS sizing. Confirms 0.3-0.5x peak ratio for demand charge optimization.",
  },
  "nrel-atb-pv-battery": {
    ...
    lastVerified: "2025-12-11",
    notes:
      "ILR (Inverter Loading Ratio) guidance: default 1.34, trending toward 1.7+ for DC-coupled systems to capture clipped energy.",
  },
  "eia-ilr-explanation": {
    ...
    lastVerified: "2025-12-11",
    notes:
      "Explains DC-to-AC capacity ratio (ILR). DC capacity typically 10-30% higher than AC capacity for economic optimization.",
  },
  "ladwp-backup-guide": {
    ...
    lastVerified: "2025-12-11",
    notes:
      "Generator sizing guidance: size to critical load, not total facility load. Includes industry-specific critical load percentages.",
  },
  "nec-700-702": {
    id: "nec-700-702",
    ...
    lastVerified: "2025-12-11",
    notes:
      "Defines emergency, legally required, and optional standby system requirements. Basis for critical load classification.",
  },
  "wpp-generator-sizing": {
    ...
    lastVerified: "2025-12-11",
    notes:
      "Generator sizing best practices: 80% continuous load capacity ideal, 25% reserve margin for motor starting.",
  },
  "ieee-446-1995": {
    id: "ieee-446-1995",
    ...
    lastVerified: "2025-12-11",
    notes:
      "Orange Book - defines critical, essential, and non-essential loads. Foundation for industry critical load percentages.",
  },
};
...
export const PRICING_BENCHMARKS: Record<string, PricingBenchmark> = {
  ...
  "bess-lfp-utility-scale": {
    ...
    deviationNotes:
      "Q4 2024 - Q1 2025 market reality: $85-125/kWh for 3-50 MW systems. NREL ATB 2024 ($334/kWh) lags behind actual market conditions (30-40% higher than current prices). Market drivers: Chinese LFP oversupply, cell price collapse ($50-60/kWh), CATL/BYD/EVE/Hithium competition.",
  },
  "bess-lfp-commercial": {
    value: 325,
    unit: "$/kWh",
    ...
    validUntil: "2025-03-31",
    deviationNotes:
      "Q4 2024 - Q1 2025 market reality: $250-400/kWh for 100-500 kWh commercial systems. Higher integration costs for smaller systems. NREL ATB 2024 ($450-550/kWh) reflects 2022-2023 data.",
  },
  "bess-floor-price": {
    value: 100,
    unit: "$/kWh",
  ...
  "bess-ratio-peak-shaving": {
    ...
    deviationNotes:
      "Optimal economic sizing: shave top 40% of demand peaks. IEEE 4538388, MDPI Energies 11(8):2048.",
  },
  ...
  "bess-ratio-resilience": {
    ...
    validUntil: "2026-12-11",
    deviationNotes:
      "Cover critical loads during outages. Based on IEEE 446 critical load analysis.",
  },
  ...
  "solar-ilr-dc-coupled": {
    ...
    validUntil: "2026-12-11",
    deviationNotes:
      "DC-coupled default ILR. NREL ATB 2024 recommends 1.34, industry trending toward 1.4-1.7.",
  },
  "solar-ilr-dc-aggressive": {
    ...
    validUntil: "2026-12-11",
    deviationNotes:
      "Higher ILR for maximum clipped energy recovery. EIA Today in Energy confirms DC 10-30% higher than AC.",
  },
  ...
  "generator-reserve-margin": {
    ...
    validUntil: "2026-12-11",
    deviationNotes:
      "25% reserve for motor starting currents and load growth. IEEE 446, NEC 700/701/702, WPP Guide.",
  },
  ...
  "critical-load-data-center": {
    ...
    validUntil: "2026-12-11",
    deviationNotes:
      "100% uptime requirement, all IT loads critical. Tier III/IV data center standards.",
  },
  "critical-load-hospital": {
    ...
    validUntil: "2026-12-11",
    deviationNotes:
      "Life safety systems + essential electrical. Some HVAC/lighting deferrable. NEC 517, NFPA 99.",
  },
  "critical-load-hotel": {
    value: 0.5,
    unit: "ratio (Critical/Peak)",
    ...
    validUntil: "2026-12-11",
    deviationNotes:
      "Life safety, elevators, refrigeration, limited HVAC. LADWP commercial guidance.",
  },
...
export const REGIONAL_ADJUSTMENTS: Record<
  string,
  { multiplier: number; sourceId: string; reason: string }
> = {
  california: {
    multiplier: 1.15,
    sourceId: "nrel-cost-benchmark-2024",
...
export function validatePriceAgainstBenchmark(
  value: number,
  benchmarkId: string,
  tolerance: number = 0.2 // 20% tolerance by default
  ...
  return {
    ...
    methodology: {
      ...
      formulas: [
        ...
        ...(includeSolar
          ? [`solarPower_kW = ${bessPower_kW} × ${solarInfo?.ratio} = ${solarPower_kW}`]
          : []),
        ...(includeGenerator
          ? [
