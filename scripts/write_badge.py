...
badge = r"""/**
 * StackQuote(tm) Badge - CANONICAL SPEC v4.0
 * Visual identity for Energy Stacking(tm):
 * three stacked layer bars (solar amber / BESS blue / EV emerald).
 * Border: emerald. Tooltip: Energy Stacking(tm) messaging.
 */
  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        aria-label="StackQuote(tm) verified energy stack analysis"
      >
...
# Replace placeholder (tm) notation with actual trademark symbol
badge = badge.replace("(tm)", "\u2122")

path = "/Users/robertchristopher/merlin2/src/components/shared/TrueQuoteBadgeCanonical.tsx"
with open(path, "w", encoding="utf-8") as f:
    f.write(badge)

print(f"Written {len(badge)} bytes to {path}")
