...
const QuoteReviewWorkflow: React.FC<QuoteReviewWorkflowProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'reviewers' | 'comments' | 'history'>('overview');
  ...
  const handleReviewerAction = (reviewerId: string, action: 'approved' | 'rejected' | 'commented') => {
    if (!review) return;
    ...
    const updatedReview = {
      ...
      reviewers: review.reviewers.map(r =>
        r.id === reviewerId
          ? { ...r, status: action, approvedAt: new Date().toISOString() }
          : r
      ),
      lastModified: new Date().toISOString(),
    };
            ...
            <div className="space-y-6">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{new Date(review.lastModified).toLocaleDateString()}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  {review.status === 'shared' && (
                    <div className="col-span-2 p-4 bg-blue-50 rounded-md text-center">
                      <p className="text-blue-900 font-semibold">✓ Quote has been shared with client</p>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  {review.versionHistory.slice(-5).reverse().map((entry, idx) => (
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`px-2 py-1 rounded text-xs font-semibold ${
                              ...
                              reviewer.status === 'commented' ? 'bg-blue-100 text-blue-700' :
                          ...
                          {reviewer.approvedAt && (
                            <p className="text-xs text-gray-500 mt-1">
                              {reviewer.status} on {new Date(reviewer.approvedAt).toLocaleDateString()}
                            </p>
                          )}
                        </div>
          ...
          {activeTab === 'comments' && (
            <div className="space-y-4">
              ...
              <div className="border-t pt-4">
                <h3 className="font-semibold text-lg mb-3">All Comments ({review.comments.length})</h3>
                    ...
                    {review.comments.map((comment) => (
                      <div
                        ...
                        className={`border rounded-lg p-4 ${
                          comment.resolved ? 'bg-gray-50 border-gray-200' : 'bg-white border-purple-200'
                        }`}
                      >
