...
import {
  ...
  Home, Battery, Gauge,
  // Better industry icons
  Store, Landmark, ShoppingCart, CircleDollarSign, Stethoscope,
  School, PlaneTakeoff, Cog, Server, Thermometer, Tractor, Sprout,
  Network, Building as Apartment, Users
} from 'lucide-react';
import type { WizardState } from '../types/wizardTypes';
import { INDUSTRY_CATEGORIES, findIndustryById, findCategoryByIndustryId, getPopularIndustries } from '@/components/wizard/constants/industryCategories';
...
const INDUSTRY_TABS: TabCategory[] = [
  {
    ...
    industries: [
      ...
      { id: 'retail', name: 'Retail & Shopping', icon: Store },
      { id: 'office', name: 'Office Buildings', icon: Building2 },
      { id: 'shopping-center', name: 'Shopping Center', icon: ShoppingCart },
      { id: 'casino', name: 'Casino & Gaming', icon: CircleDollarSign },
      { id: 'tribal-casino', name: 'Tribal Casino', icon: Dices },
      { id: 'hospital', name: 'Hospital & Healthcare', icon: Stethoscope },
      { id: 'college', name: 'College & University', icon: School },
      { id: 'government', name: 'Government & Public', icon: Landmark },
  ...
  },
  {
    ...
    industries: [
      { id: 'manufacturing', name: 'Manufacturing', icon: Cog },
      { id: 'warehouse', name: 'Warehouse & Logistics', icon: Warehouse },
      { id: 'data-center', name: 'Data Center', icon: Server },
      { id: 'cold-storage', name: 'Cold Storage', icon: Thermometer },
      { id: 'agricultural', name: 'Agricultural', icon: Tractor },
      { id: 'indoor-farm', name: 'Indoor Farm', icon: Sprout },
      { id: 'microgrid', name: 'Microgrid & Renewable', icon: Network },
    ],
  },
  {
    id: 'housing',
    ...
    industries: [
      ...
      { id: 'apartment', name: 'Apartment Complex', icon: Users },
    ],
  },
];
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <MerlinGreeting
          ...
          acknowledgment={`Great! You're in ${wizardState.state || 'your selected location'}${wizardState.goals.length > 0 ? ` with ${wizardState.goals.length} goal${wizardState.goals.length > 1 ? 's' : ''} selected` : ''}`}
          stepDescription="What type of business are you? I'll calculate your energy savings based on your industry - different businesses have different energy profiles!"
          estimatedTime="1 min"
          instructions={[
            { text: "Choose a Guided Experience OR...", highlight: "Guided Experience" },
            { text: "Select from All Industries below", highlight: "All Industries" },
            { text: "I'll load custom questions for you", highlight: "custom questions" },
          ]}
          recommendation={{
            title: "💡 Merlin's Recommendation",
            content: <><strong>Hotels, Car Washes, and EV Charging</strong> have guided experiences with custom calculators. Other industries use our smart wizard!</>
          }}
          proTip={{
            title: "👆 Pro Tip: Click the Sun Icons!",
            content: "The <strong>☀️ Solar Opportunity</strong> suns in the header show your location's solar potential. Click them to see recommendations!"
          }}
        />
      ...
      <FloatingNavigationArrows
        ...
        forwardLabel="Continue to Facility Details"
      />
    </div>
  );
}
